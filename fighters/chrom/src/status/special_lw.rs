...
unsafe extern "C" fn chrom_special_lw_exec(fighter: &mut L2CFighterCommon) -> L2CValue {
    if VarModule::is_flag(fighter.module_accessor, vars::chrom::status::flag::SPECIAL_LW_CHANGE_KINETIC) {
        ...
        VarModule::off_flag(fighter.module_accessor, vars::chrom::status::flag::SPECIAL_LW_CHANGE_KINETIC);
    }
    0.into()
}
