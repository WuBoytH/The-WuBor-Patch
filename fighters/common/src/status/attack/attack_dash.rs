...
unsafe extern "C" fn status_attackdash(fighter: &mut L2CFighterCommon) -> L2CValue {
    VarModule::set_float(fighter.module_accessor, vars::attack_dash::float::FALL_SPEED_Y_MUL, -1.0);
...
unsafe extern "C" fn status_attackdash_main(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    if situation == *SITUATION_KIND_GROUND {
        if VarModule::is_flag(fighter.module_accessor, vars::attack_dash::flag::ENABLE_AIR_FALL) {
    ...
    if VarModule::is_flag(fighter.module_accessor, vars::attack_dash::flag::ENABLE_GRAVITY)
    && situation != *SITUATION_KIND_GROUND {
        VarModule::off_flag(fighter.module_accessor, vars::attack_dash::flag::ENABLE_GRAVITY);
        VarModule::on_flag(fighter.module_accessor, vars::attack_dash::flag::GRAVITY_ENABLED);
        let fall_mul = VarModule::get_float(fighter.module_accessor, vars::attack_dash::float::FALL_SPEED_Y_MUL);
    ...
    if StatusModule::is_situation_changed(fighter.module_accessor) {
        if fighter.global_table[SITUATION_KIND].get_i32() != *SITUATION_KIND_GROUND {
            ...
            if VarModule::is_flag(fighter.module_accessor, vars::attack_dash::flag::ENABLE_AIR_CONTINUE) {
                ...
                if VarModule::is_flag(fighter.module_accessor, vars::attack_dash::flag::GRAVITY_ENABLED) {
                    let fall_mul = VarModule::get_float(fighter.module_accessor, vars::attack_dash::float::FALL_SPEED_Y_MUL);
                    if fall_mul.signum() != -1.0 {
                        let air_accel_y = WorkModule::get_param_float(fighter.module_accessor, hash40("air_accel_y"), 0);
                        sv_kinetic_energy!(
            ...
            if VarModule::is_flag(fighter.module_accessor, vars::attack_dash::flag::ENABLE_AIR_LANDING) {
                fighter.change_status(
