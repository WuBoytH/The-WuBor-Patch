use super::*;
use crate::status::attack::attack::*;
...
unsafe extern "C" fn sub_transition_group_check_air_escape(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    && WorkModule::is_enable_transition_term(fighter.module_accessor, *FIGHTER_STATUS_TRANSITION_TERM_ID_CONT_ESCAPE_AIR) {
        ...
        let cancel = !CancelModule::is_enable_cancel(fighter.module_accessor) && VarModule::is_flag(fighter.module_accessor, vars::fighter::status::flag::FORCE_ESCAPE_AIR_SLIDE_IN_STATUS);
...
unsafe extern "C" fn sub_transition_group_check_air_cliff(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    && GroundModule::can_entry_cliff(fighter.module_accessor) != 0 {
        ...
        && WorkModule::is_enable_transition_term(fighter.module_accessor, *FIGHTER_STATUS_TRANSITION_TERM_ID_CLIFF_CATCH)
