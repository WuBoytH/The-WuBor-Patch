...
unsafe extern "C" fn duckhunt_special_hi_fly_pre(fighter: &mut L2CFighterCommon) -> L2CValue {
...
pub fn install(agent: &mut Agent) {
    agent.status(Pre, *FIGHTER_DUCKHUNT_STATUS_KIND_SPECIAL_HI_FLY, duckhunt_special_hi_fly_pre);
}