...
unsafe extern "C" fn on_main(weapon: &mut L2CFighterBase) {
    ...
    && VarModule::is_flag(weapon.module_accessor, vars::eflame_esword::status::flag::ENABLE_EARLY_SPIN)
    && ControlModule::check_button_trigger(weapon.module_accessor, *CONTROL_PAD_BUTTON_SPECIAL) {
        ...
        VarModule::off_flag(weapon.module_accessor, vars::eflame_esword::status::flag::ENABLE_EARLY_SPIN);
    }
}
