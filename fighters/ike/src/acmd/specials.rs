...
unsafe extern "C" fn game_specialhi1(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        ...
        VarModule::on_flag(agent.module_accessor, vars::ike::status::flag::SPECIAL_HI_ARMOR);
    }
}
...
unsafe extern "C" fn game_specialhi2(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        ...
        VarModule::off_flag(agent.module_accessor, vars::ike::status::flag::SPECIAL_HI_ARMOR);
    ...
    if macros::is_excute(agent) {
        macros::ATTACK(agent, 0, 0, Hash40::new("top"), 1.0, 367, 100, 50, 0, 9.0, 0.0, 16.0, 14.0, Some(0.0), Some(8.0), Some(14.0), 0.5, 0.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 10, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_SWORD);
    }
...
unsafe extern "C" fn game_specialhi4(agent: &mut L2CAgentBase) {
    if macros::is_excute(agent) {
        macros::ATTACK(agent, 0, 0, Hash40::new("top"), 6.0, 50, 160, 0, 55, 10.0, 0.0, 6.0, 11.8, Some(0.0), Some(11.0), Some(11.8), 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_IKE, *ATTACK_REGION_SWORD);
    }
    frame(agent.lua_state_agent, 5.0);
    if macros::is_excute(agent) {
        AttackModule::clear_all(agent.module_accessor);
...
unsafe extern "C" fn game_speciallwhit(agent: &mut L2CAgentBase) {
    if !VarModule::is_flag(agent.module_accessor, vars::ike::status::flag::SPECIAL_LW_WHIFF) {
        if macros::is_excute(agent) {
    ...
    frame(agent.lua_state_agent, 7.0);
    if VarModule::is_flag(agent.module_accessor, vars::ike::status::flag::SPECIAL_LW_WHIFF) {
        MiscModule::calc_motion_rate_from_cancel_frame(agent, 7.0, 5.0);
    }
    else {
        MiscModule::calc_motion_rate_from_cancel_frame(agent, 7.0, -15.0);
    }
    // if macros::is_excute(agent) {
    //     AttackModule::clear_all(agent.module_accessor);
    // }
...
unsafe extern "C" fn effect_speciallwhit(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        ...
        macros::AFTER_IMAGE4_ON_arg29(agent, Hash40::new("tex_ike_sword5"), Hash40::new("tex_ike_sword2"), 5, Hash40::new("sword"), 0, 1, 0, Hash40::new("sword"), 0, 16.2, 0, true, Hash40::new("null"), Hash40::new("sword"), 0, 0, 0, 0, 0, 0, 1, 0, *EFFECT_AXIS_X, 0, *TRAIL_BLEND_ALPHA, 101, *TRAIL_CULL_NONE, 1.5, 0.1);
        macros::EFFECT_FOLLOW(agent, Hash40::new("ike_counter_attack"), Hash40::new("top"), 0, 0, 0, 0, 0, 0, 1, true);
    }
    frame(agent.lua_state_agent, 11.0);
    if macros::is_excute(agent) {
        macros::EFFECT_OFF_KIND(agent, Hash40::new("ike_sword2"), false, true);
...
unsafe extern "C" fn sound_speciallwhit(agent: &mut L2CAgentBase) {
    ...
    if !VarModule::is_flag(agent.module_accessor, vars::ike::status::flag::SPECIAL_LW_WHIFF) {
        if macros::is_excute(agent) {
            macros::PLAY_SE_REMAIN(agent, Hash40::new("se_ike_special_l02"));
        }
    }
    wait(agent.lua_state_agent, 1.0);
    if macros::is_excute(agent) {
        macros::PLAY_SE_REMAIN(agent, Hash40::new("se_ike_swing_ll"));
    }
    wait(agent.lua_state_agent, 1.0);
    if macros::is_excute(agent) {
        macros::PLAY_SE_REMAIN(agent, Hash40::new("vc_ike_special_l01"));
    }
}
