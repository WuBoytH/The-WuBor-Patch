...
unsafe extern "C" fn game_speciallwhit(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        ...
        if AttackModule::is_infliction_status(agent.module_accessor, *COLLISION_KIND_MASK_HIT) {
            ...
            VarModule::set_float(owner_module_accessor, vars::kamui::instance::float::DRAGON_INSTALL, 600.0);
            VarModule::set_float(owner_module_accessor, vars::kamui::instance::float::DRAGON_INSTALL_TIMER, 24.0);
        }
    }
}
