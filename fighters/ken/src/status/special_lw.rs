...
unsafe extern "C" fn ken_special_lw_main_loop(fighter: &mut L2CFighterCommon) -> L2CValue {
    if VarModule::is_flag(fighter.module_accessor, vars::ken::status::flag::SPECIAL_LW_ENABLE_ACTION) {
        ...
        VarModule::off_flag(fighter.module_accessor, vars::ken::status::flag::SPECIAL_LW_ENABLE_ACTION);
        VarModule::on_flag(fighter.module_accessor, vars::ken::status::flag::SPECIAL_LW_ENABLED_ACTION);
    }
    if VarModule::is_flag(fighter.module_accessor, vars::ken::status::flag::SPECIAL_LW_UNABLE_ACTION) {
        ...
        VarModule::off_flag(fighter.module_accessor, vars::ken::status::flag::SPECIAL_LW_UNABLE_ACTION);
        VarModule::off_flag(fighter.module_accessor, vars::ken::status::flag::SPECIAL_LW_ENABLED_ACTION);
    }
    if VarModule::is_flag(fighter.module_accessor, vars::ken::status::flag::SPECIAL_LW_RESET_GRAVITY) {
        if fighter.global_table[SITUATION_KIND].get_i32() != *SITUATION_KIND_GROUND {
            sv_kinetic_energy!(
                reset_energy,
                fighter,
        ...
        VarModule::off_flag(fighter.module_accessor, vars::ken::status::flag::SPECIAL_LW_RESET_GRAVITY);
    }
    ...
    if VarModule::is_flag(fighter.module_accessor, vars::ken::status::flag::SPECIAL_LW_ENABLED_ACTION)
...
unsafe extern "C" fn ken_special_lw_end(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    && [
        ...
        *FIGHTER_RYU_STATUS_KIND_SPECIAL_N2_COMMAND
        ...
        VarModule::on_flag(fighter.module_accessor, vars::ken::instance::flag::QUICK_STEP_INHERIT)
    }
    else {
...
pub fn install(agent: &mut Agent) {
    agent.status(Pre, *FIGHTER_STATUS_KIND_SPECIAL_LW, ken_special_lw_pre);
    agent.status(Init, *FIGHTER_STATUS_KIND_SPECIAL_LW, ken_special_lw_init);
    agent.status(Main, *FIGHTER_STATUS_KIND_SPECIAL_LW, ken_special_lw_main);
    agent.status(End, *FIGHTER_STATUS_KIND_SPECIAL_LW, ken_special_lw_end);
}