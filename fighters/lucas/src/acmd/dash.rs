...
unsafe extern "C" fn effect_dash(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        macros::FOOT_EFFECT(agent, Hash40::new("sys_dash_smoke"), Hash40::new("top"), -2, 0, 0, 0, 0, 0, 0.7, 0, 0, 0, 0, 0, 0, false);
    }
...
unsafe extern "C" fn sound_dash(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        ...
        // macros::SET_PLAY_INHIVIT(agent, Hash40::new("se_lucas_dash_start"), 20);
    }
    wait(agent.lua_state_agent, 17.0);
    if macros::is_excute(agent) {
        macros::PLAY_STEP(agent, Hash40::new("se_lucas_step_right_l"));
    }
    wait(agent.lua_state_agent, 1.0);
    if macros::is_excute(agent) {
        macros::PLAY_STEP(agent, Hash40::new("se_lucas_step_left_l"));
    }
}
