...
pub unsafe extern "C" fn marth_check_ground_special_pre(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    && VarModule::is_flag(fighter.module_accessor, vars::marth::instance::flag::IS_STANCE) {
        ...
        fighter.change_status(vars::marth::status::STANCE_ENTER.into(), clear_buffer.into());
        return true.into();
    }
    false.into()
}
...
pub unsafe extern "C" fn marth_check_air_special_pre(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    && VarModule::is_flag(fighter.module_accessor, vars::marth::instance::flag::IS_STANCE) {
        ...
        fighter.change_status(vars::marth::status::STANCE_ENTER.into(), false.into());
        return true.into();
    }
    false.into()
}
