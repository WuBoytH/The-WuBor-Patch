...
unsafe extern "C" fn marth_stance_toggle_handler(fighter: &mut L2CFighterCommon, stance: bool) {
    VarModule::set_flag(fighter.module_accessor, vars::marth::instance::flag::IS_STANCE, !stance);
    ...
    VarModule::set_int(fighter.module_accessor, vars::marth::instance::int::STANCE_CHANGE_LOCKOUT, vl::param_stance::stance_change_lockout_frame);
...
unsafe extern "C" fn marth_check_stance(fighter: &mut L2CFighterCommon) {
    if StatusModule::situation_kind(fighter.module_accessor) == *SITUATION_KIND_GROUND {
        VarModule::off_flag(fighter.module_accessor, vars::marth::instance::flag::AIR_STANCE);
    }

    if VarModule::get_int(fighter.module_accessor, vars::marth::instance::int::STANCE_CHANGE_LOCKOUT) <= 0 {
        let stance = VarModule::is_flag(fighter.module_accessor, vars::marth::instance::flag::IS_STANCE);
    ...
    if VarModule::get_int(fighter.module_accessor, vars::marth::instance::int::STANCE_CHANGE_LOCKOUT) > 0 {
        VarModule::dec_int(fighter.module_accessor, vars::marth::instance::int::STANCE_CHANGE_LOCKOUT);
    }
}
