...
unsafe extern "C" fn marth_speciallw_attack_lw3_main(fighter: &mut L2CFighterCommon) -> L2CValue {
    VarModule::off_flag(fighter.module_accessor, vars::marth::status::flag::ATTACK_3_CHANGE_MOTION);
    MotionModule::change_motion(
        fighter.module_accessor,
...
unsafe extern "C" fn marth_speciallw_attack_lw3_main_loop(fighter: &mut L2CFighterCommon) -> L2CValue {
    if fighter.global_table[SITUATION_KIND].get_i32() == *SITUATION_KIND_GROUND {
        if VarModule::is_flag(fighter.module_accessor, vars::marth::status::flag::ATTACK_3_CHANGE_MOTION) {
            VarModule::off_flag(fighter.module_accessor, vars::marth::status::flag::ATTACK_3_CHANGE_MOTION);
            if ControlModule::check_button_on(fighter.module_accessor, *CONTROL_PAD_BUTTON_ATTACK) {
                fighter.change_status(vars::marth::status::STANCE_ATTACK_LW4.into(), true.into());
                return 1.into();
            }
        }
        ...
        if MotionModule::is_end(fighter.module_accessor) {
            if !VarModule::is_flag(fighter.module_accessor, vars::marth::instance::flag::IS_STANCE) {
                ...
                fighter.change_status(vars::marth::status::STANCE_SQUAT_WAIT.into(), false.into());
            }
        }
    }
    else {
...
unsafe extern "C" fn marth_speciallw_attack_f3_main(fighter: &mut L2CFighterCommon) -> L2CValue {
    VarModule::off_flag(fighter.module_accessor, vars::marth::status::flag::ATTACK_3_CHANGE_MOTION);
    VarModule::off_flag(fighter.module_accessor, vars::marth::status::flag::ATTACK_F3_HEAVY);
    MotionModule::change_motion(
        fighter.module_accessor,
    ...
    if fighter.global_table[SITUATION_KIND].get_i32() == *SITUATION_KIND_GROUND {
        if VarModule::is_flag(fighter.module_accessor, vars::marth::status::flag::ATTACK_3_CHANGE_MOTION) {
            ...
            if ControlModule::check_button_on(fighter.module_accessor, *CONTROL_PAD_BUTTON_ATTACK) {
                ...
                VarModule::on_flag(fighter.module_accessor, vars::marth::status::flag::ATTACK_F3_HEAVY);
            }
        }
    }
    marth_speciallw_attack_main_loop(fighter)
...
pub fn install(agent: &mut Agent) {
    agent.status(Pre, vars::marth::status::STANCE_ATTACK, marth_speciallw_attack_pre);
    agent.status(Main, vars::marth::status::STANCE_ATTACK, marth_speciallw_attack_main);
    agent.status(End, vars::marth::status::STANCE_ATTACK, marth_speciallw_attack_end);

    agent.status(Pre, vars::marth::status::STANCE_ATTACK_LW3, marth_speciallw_attack_pre);
    agent.status(Main, vars::marth::status::STANCE_ATTACK_LW3, marth_speciallw_attack_lw3_main);
    agent.status(End, vars::marth::status::STANCE_ATTACK_LW3, marth_speciallw_attack_end);

    agent.status(Pre, vars::marth::status::STANCE_ATTACK_LW4, marth_speciallw_attack_pre);
    agent.status(Main, vars::marth::status::STANCE_ATTACK_LW4, marth_speciallw_attack_lw4_main);
    agent.status(End, vars::marth::status::STANCE_ATTACK_LW4, marth_speciallw_attack_end);

    agent.status(Pre, vars::marth::status::STANCE_ATTACK_HI3, marth_speciallw_attack_pre);
    agent.status(Main, vars::marth::status::STANCE_ATTACK_HI3, marth_speciallw_attack_hi3_main);
    agent.status(End, vars::marth::status::STANCE_ATTACK_HI3, marth_speciallw_attack_end);

    agent.status(Pre, vars::marth::status::STANCE_ATTACK_F3, marth_speciallw_attack_pre);
    agent.status(Main, vars::marth::status::STANCE_ATTACK_F3, marth_speciallw_attack_f3_main);
    agent.status(End, vars::marth::status::STANCE_ATTACK_F3, marth_speciallw_attack_end);

    agent.status(Pre, vars::marth::status::STANCE_ATTACK_B3, marth_speciallw_attack_pre);
    agent.status(Main, vars::marth::status::STANCE_ATTACK_B3, marth_speciallw_attack_b3_main);
    agent.status(End, vars::marth::status::STANCE_ATTACK_B3, marth_speciallw_attack_end);
}