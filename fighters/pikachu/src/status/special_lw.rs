...
unsafe extern "C" fn pikachu_special_lw_main(fighter: &mut L2CFighterCommon) -> L2CValue {
    VarModule::on_flag(fighter.module_accessor, vars::pikachu::status::flag::SPECIAL_LW_START);
...
unsafe extern "C" fn pikachu_special_lw_main_loop(fighter: &mut L2CFighterCommon) -> L2CValue {
    if VarModule::is_flag(fighter.module_accessor, vars::pikachu::status::flag::SPECIAL_LW_START) {
        if MotionModule::is_end(fighter.module_accessor) {
            ...
            VarModule::off_flag(fighter.module_accessor, vars::pikachu::status::flag::SPECIAL_LW_START);
        }
    }
    else {
        if VarModule::is_flag(fighter.module_accessor, vars::pikachu::status::flag::SPECIAL_LW_ENABLE_GRAVITY) {
            KineticModule::change_kinetic(fighter.module_accessor, *FIGHTER_KINETIC_TYPE_FALL);
            VarModule::off_flag(fighter.module_accessor, vars::pikachu::status::flag::SPECIAL_LW_ENABLE_GRAVITY);
        }
        ...
        if VarModule::is_flag(fighter.module_accessor, vars::pikachu::status::flag::SPECIAL_LW_ENABLE_LANDING)
