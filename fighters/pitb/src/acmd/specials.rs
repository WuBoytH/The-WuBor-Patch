...
unsafe extern "C" fn expression_specialnstart(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        VisibilityModule::set_status_default_int64(agent.module_accessor, hash40("weapon"), hash40("weapon_final"));
    }
}
...
unsafe extern "C" fn expression_specialnfires(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        VisibilityModule::set_int64(agent.module_accessor, hash40("weapon"), hash40("weapon_none"));
    }
