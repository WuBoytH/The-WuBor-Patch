...
pub fn install(agent: &mut Agent) {
    agent.status(Pre, *FIGHTER_RIDLEY_STATUS_KIND_SPECIAL_HI_CHARGE_HI, ridley_special_hi_charge_hi_pre);
    agent.status(Main, *FIGHTER_RIDLEY_STATUS_KIND_SPECIAL_HI_CHARGE_HI, ridley_special_hi_charge_hi_main);

    agent.status(Pre, *FIGHTER_RIDLEY_STATUS_KIND_SPECIAL_HI_CHARGE_F, ridley_special_hi_charge_f_pre);
    agent.status(Main, *FIGHTER_RIDLEY_STATUS_KIND_SPECIAL_HI_CHARGE_F, ridley_special_hi_charge_f_main);

    agent.status(Pre, *FIGHTER_RIDLEY_STATUS_KIND_SPECIAL_HI_CHARGE_B, ridley_special_hi_charge_b_pre);
    agent.status(Main, *FIGHTER_RIDLEY_STATUS_KIND_SPECIAL_HI_CHARGE_B, ridley_special_hi_charge_b_main);

    agent.status(Pre, *FIGHTER_RIDLEY_STATUS_KIND_SPECIAL_HI_CHARGE_LW, ridley_special_hi_charge_lw_pre);
}