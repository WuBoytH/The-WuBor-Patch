...
unsafe extern "C" fn rockman_check_special_uniq(fighter: &mut L2CFighterCommon) -> L2CValue {
    if VarModule::is_flag(fighter.module_accessor, vars::rockman::instance::flag::CHARGE_SHOT_RELEASE)
    && VarModule::is_flag(fighter.module_accessor, vars::rockman::instance::flag::CHARGE_SHOT_PLAYED_FX) {
