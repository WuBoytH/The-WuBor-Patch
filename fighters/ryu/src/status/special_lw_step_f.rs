...
unsafe extern "C" fn ryu_special_lw_step_f_substatus(fighter: &mut L2CFighterCommon, _param_1: L2CValue) -> L2CValue {
    if VarModule::is_flag(fighter.module_accessor, vars::ryu::status::flag::SPECIAL_LW_RUSH_ENABLE_ATTACK) {
        ...
        VarModule::off_flag(fighter.module_accessor, vars::ryu::status::flag::SPECIAL_LW_RUSH_ENABLE_ATTACK);
    }
    if VarModule::is_flag(fighter.module_accessor, vars::ryu::status::flag::SPECIAL_LW_RUSH_RESUME_ENERGY) {
        if fighter.global_table[SITUATION_KIND].get_i32() != *SITUATION_KIND_GROUND {
        ...
        VarModule::off_flag(fighter.module_accessor, vars::ryu::status::flag::SPECIAL_LW_RUSH_RESUME_ENERGY);
    }
    0.into()
}
