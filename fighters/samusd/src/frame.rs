...
unsafe extern "C" fn samusd_special_lw_bounce(fighter: &mut L2CFighterCommon) {
    ...
    || MotionModule::motion_kind(fighter.module_accessor) == hash40("special_air_lw") {
        ...
        && !VarModule::is_flag(fighter.module_accessor, vars::samusd::status::flag::SPECIAL_LW_BOUNCE) {
            ...
            VarModule::on_flag(fighter.module_accessor, vars::samusd::status::flag::SPECIAL_LW_BOUNCE);
        }
    }
}
...
unsafe extern "C" fn samusd_reset_attack_air_n_float(fighter: &mut L2CFighterCommon) {
    if StatusModule::situation_kind(fighter.module_accessor) == *SITUATION_KIND_GROUND {
        if VarModule::is_flag(fighter.module_accessor, vars::samusd::instance::flag::ATTACK_AIR_N_FLOAT) {
            VarModule::off_flag(fighter.module_accessor, vars::samusd::instance::flag::ATTACK_AIR_N_FLOAT);
        }
    }
}
