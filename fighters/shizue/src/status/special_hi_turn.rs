...
unsafe extern "C" fn murabito_special_hi_turn_pre(fighter: &mut L2CFighterCommon) -> L2CValue {
...
pub fn install(agent: &mut Agent) {
    agent.status(Pre, *FIGHTER_MURABITO_STATUS_KIND_SPECIAL_HI_TURN, murabito_special_hi_turn_pre);
}