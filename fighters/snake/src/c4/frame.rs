...
unsafe extern "C" fn set_tracker_eff(weapon: &mut L2CWeaponCommon, hash: Hash40, color: &Option<SnakeC4Color>, num: i32) {
    ...
    VarModule::set_int(weapon.module_accessor, vars::snake_c4::instance::int::TRACKER_EFF + num, eff_handle as i32);
}
...
unsafe extern "C" fn c4_marker(weapon: &mut L2CWeaponCommon) {
    ...
    && !VarModule::is_flag(weapon.module_accessor, vars::snake_c4::instance::flag::TRACKER_ENABLED) {
        VarModule::on_flag(weapon.module_accessor, vars::snake_c4::instance::flag::TRACKER_ENABLED);
        VarModule::on_flag(weapon.module_accessor, vars::snake_c4::instance::flag::TRACKER_VISIBLE);
...
unsafe extern "C" fn tracker_toggle(weapon: &mut L2CWeaponCommon) {
    let visible = !VarModule::is_flag(weapon.module_accessor, vars::snake_c4::instance::flag::TRACKER_VISIBLE);
    for num in 0..2 {
        let eff_handle = VarModule::get_int(weapon.module_accessor, vars::snake_c4::instance::int::TRACKER_EFF + num) as u32;
    ...
    VarModule::set_flag(weapon.module_accessor, vars::snake_c4::instance::flag::TRACKER_VISIBLE, visible);
}
