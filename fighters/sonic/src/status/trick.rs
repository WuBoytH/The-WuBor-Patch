...
unsafe extern "C" fn sonic_trick_exec(fighter: &mut L2CFighterCommon) -> L2CValue {
    if VarModule::is_flag(fighter.module_accessor, vars::sonic::status::flag::TRICK_ENABLE_MOVEMENT) {
        VarModule::off_flag(fighter.module_accessor, vars::sonic::status::flag::TRICK_ENABLE_MOVEMENT);
    ...
    if VarModule::is_flag(fighter.module_accessor, vars::sonic::status::flag::TRICK_ENABLE_CONTROL) {
        VarModule::off_flag(fighter.module_accessor, vars::sonic::status::flag::TRICK_ENABLE_CONTROL);
        sv_kinetic_energy!(
            reset_energy,
            fighter,
