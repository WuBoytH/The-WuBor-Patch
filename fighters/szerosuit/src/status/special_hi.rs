...
unsafe extern "C" fn szerosuit_specialhi_main(fighter: &mut L2CFighterCommon) -> L2CValue {
    WorkModule::set_int64(fighter.module_accessor, hash40("special_hi"), *FIGHTER_STATUS_SUPER_JUMP_PUNCH_WORK_INT_MOTION_KIND);
    WorkModule::set_int64(fighter.module_accessor, hash40("special_air_hi"), *FIGHTER_STATUS_SUPER_JUMP_PUNCH_WORK_INT_MOTION_KIND_AIR);
...
unsafe extern "C" fn szerosuit_specialhi_main_loop_helper(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    if VarModule::is_flag(fighter.module_accessor, vars::szerosuit::status::flag::SPECIAL_HI_DECIDE_MOTION) {
        ...
        VarModule::off_flag(fighter.module_accessor, vars::szerosuit::status::flag::SPECIAL_HI_DECIDE_MOTION);
    }
    if [
        hash40("special_hi_2"),
