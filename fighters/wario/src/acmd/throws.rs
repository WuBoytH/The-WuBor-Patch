...
unsafe extern "C" fn game_throwf(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        ...
        macros::CHECK_FINISH_CAMERA(agent, 16.0, 9.0);
...
unsafe extern "C" fn game_throwb(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        VarModule::on_flag(agent.module_accessor, vars::wario::status::flag::THROW_B_MOVE);
    }
    ...
    if macros::is_excute(agent) {
        ...
        macros::CHECK_FINISH_CAMERA(agent, 18.0, 4.0);
        lua_bind::FighterCutInManager::set_throw_finish_zoom_rate(singletons::FighterCutInManager(), 1.5);
    }
    frame(agent.lua_state_agent, 48.0);
    if macros::is_excute(agent) {
        VarModule::off_flag(agent.module_accessor, vars::wario::status::flag::THROW_B_MOVE);
...
unsafe extern "C" fn game_throwlw(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        ...
        AttackModule::set_catch_only_all(agent.module_accessor, true, false);
        macros::CHECK_FINISH_CAMERA(agent, -2.0, 0.0);
