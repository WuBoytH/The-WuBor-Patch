...
unsafe extern "C" fn wario_throw_exec(fighter: &mut L2CFighterCommon) -> L2CValue {
    if VarModule::is_flag(fighter.module_accessor, vars::wario::status::flag::THROW_B_MOVE) {
        ...
        if !VarModule::is_flag(fighter.module_accessor, vars::wario::status::flag::THROW_B_CONTROL_RESET) {
            sv_kinetic_energy!(
                reset_energy,
                fighter,
            ...
            VarModule::on_flag(fighter.module_accessor, vars::wario::status::flag::THROW_B_CONTROL_RESET);
        }
        sv_kinetic_energy!(
            set_stable_speed,
            fighter,
