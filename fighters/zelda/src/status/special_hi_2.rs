...
unsafe extern "C" fn zelda_special_hi_2_exec(fighter: &mut L2CFighterCommon) -> L2CValue {
...
pub fn install(agent: &mut Agent) {
    ...
    agent.status(Exec, *FIGHTER_ZELDA_STATUS_KIND_SPECIAL_HI_2, zelda_special_hi_2_exec);
}