...
pub fn install() {
    brave_attackairn::install();
    brave_attackairf::install();
    brave_attackairb::install();
    brave_attackairhi::install();
    brave_attackairhi_eff::install();
    brave_attackairlw::install();
}