...
unsafe fn chrom_special_lw_pre(fighter: &mut L2CFighterCommon) -> L2CValue {
...
unsafe fn chrom_special_lw_init(_fighter: &mut L2CFighterCommon) -> L2CValue {
    0.into()
}

#[status_script(agent = "chrom", status = FIGHTER_STATUS_KIND_SPECIAL_LW, condition = LUA_SCRIPT_STATUS_FUNC_STATUS_MAIN)]
unsafe fn chrom_special_lw_main(fighter: &mut L2CFighterCommon) -> L2CValue {
...
unsafe fn chrom_special_lw_exec(fighter: &mut L2CFighterCommon) -> L2CValue {
