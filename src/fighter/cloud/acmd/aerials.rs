...
#[acmd("cloud", "expression_attackairhi")]
...
pub fn install() {
    cloud_attackairb::install();
    cloud_attackairhi::install();
    cloud_attackairhi_exp::install();
}