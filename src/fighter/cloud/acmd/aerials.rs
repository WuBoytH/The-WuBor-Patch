...
unsafe fn cloud_attackairb(fighter: &mut L2CAgentBase) {
...
unsafe fn cloud_attackairhi(fighter: &mut L2CAgentBase) {
...
unsafe fn cloud_attackairhi_exp(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
