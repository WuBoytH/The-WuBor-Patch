...
#[skyline::hook(replace = smash::lua2cpp::L2CFighterCommon_sub_status_guard_off_main_common_cancel)]
...
#[skyline::hook(replace = smash::lua2cpp::L2CFighterCommon_status_end_GuardOff)]
