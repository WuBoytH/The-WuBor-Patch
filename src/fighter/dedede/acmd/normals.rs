...
pub fn install() {
    dedede_attack11::install();
    dedede_attack12::install();
    dedede_attackhi3::install();
    dedede_attacklw3::install();
}