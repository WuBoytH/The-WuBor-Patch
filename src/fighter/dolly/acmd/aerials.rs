...
pub fn install() {
    ...
    dolly_attackairf::install();
    dolly_attackairb::install();
    dolly_attackairhi::install();
    dolly_attackairlw::install();
}