...
unsafe fn dolly_special_hi_pre(fighter: &mut L2CFighterCommon) -> L2CValue {
...
unsafe fn dolly_special_hi_end(fighter: &mut L2CFighterCommon) -> L2CValue {
...
unsafe fn dolly_special_hi_command_end(fighter: &mut L2CFighterCommon) -> L2CValue {
...
unsafe fn dolly_special_hi_jump_end(fighter: &mut L2CFighterCommon) -> L2CValue {
    let status = fighter.global_table[STATUS_KIND].get_i32();
    if status != *FIGHTER_DOLLY_STATUS_KIND_SPECIAL_HI_JUMP
