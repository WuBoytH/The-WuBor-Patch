...
unsafe fn dolly_special_n_pre(fighter: &mut L2CFighterCommon) -> L2CValue {
...
unsafe fn dolly_special_n_main(fighter: &mut L2CFighterCommon) -> L2CValue {
...
unsafe fn dolly_special_n_end(fighter: &mut L2CFighterCommon) -> L2CValue {
