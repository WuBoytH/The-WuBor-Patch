...
unsafe fn dolly_special_sb_pre(fighter: &mut L2CFighterCommon) -> L2CValue {
...
unsafe fn dolly_special_f_attack_end(fighter: &mut L2CFighterCommon) -> L2CValue {
    VarModule::off_flag(fighter.module_accessor, dolly::status::flag::IS_SPECIAL_CANCEL);
...
unsafe fn dolly_special_b_attack_end(fighter: &mut L2CFighterCommon) -> L2CValue {
