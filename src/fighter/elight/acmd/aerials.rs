...
unsafe fn elight_attackairn(fighter: &mut L2CAgentBase) {
    ...
    if macros::is_excute(fighter) {
        ...
        macros::ATTACK(fighter, 2, 0, Hash40::new("top"), 2.0, 361, 15, 0, 25, 3.0, 0.0, 8.0, 11.5, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_G, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_PUNCH, *ATTACK_REGION_PUNCH);
        ...
        macros::ATTACK(fighter, 4, 0, Hash40::new("top"), 2.0, 75, 20, 0, 55, 3.0, 0.0, 8.0, 7.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_A, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_PUNCH, *ATTACK_REGION_PUNCH);
        macros::ATTACK(fighter, 5, 0, Hash40::new("top"), 2.0, 75, 15, 0, 55, 3.0, 0.0, 8.0, 11.5, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_A, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_PUNCH, *ATTACK_REGION_PUNCH);
...
#[acmd_script( agent = "elight", script = "effect_attackairn", category = ACMD_EFFECT )]
...
#[acmd_script( agent = "elight", script = "sound_attackairn", category = ACMD_SOUND )]
unsafe fn elight_attackairn_snd(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 2.0);
    if macros::is_excute(fighter) {
        macros::PLAY_SE(fighter, Hash40::new("se_elight_swing_s01"));
    }
}

#[acmd_script( agent = "elight", script = "expression_attackairn", category = ACMD_EXPRESSION )]
unsafe fn elight_attackairn_exp(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
...
unsafe fn elight_landingairn(_fighter: &mut L2CAgentBase) {
...
unsafe fn elight_attackairlw(fighter: &mut L2CAgentBase) {
    ...
    frame(fighter.lua_state_agent, 13.0);
    if macros::is_excute(fighter) {
        VarModule::on_flag(fighter.battle_object, elight::instance::flag::ATTACK_AIR_LW_LANDING_ATTACK);
        macros::ATTACK(fighter, 0, 0, Hash40::new("top"), 0.5, 366, 20, 10, 60, 3.5, 0.0, 4.0, 8.0, None, None, None, 0.75, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, -1.0, 3, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_magic"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_MAGIC, *ATTACK_REGION_SWORD);
        macros::ATTACK(fighter, 1, 0, Hash40::new("top"), 0.5, 366, 20, 10, 60, 2.5, 0.0, 0.0, 12.0, None, None, None, 0.75, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, -1.0, 3, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_magic"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_MAGIC, *ATTACK_REGION_SWORD);
...
#[acmd_script( agent = "elight", script = "effect_attackairlw", category = ACMD_EFFECT )]
unsafe fn elight_attackairlw_eff(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 11.0);
    if macros::is_excute(fighter) {
    ...
    if macros::is_excute(fighter) {
        ...
        macros::EFFECT_FOLLOW(fighter, Hash40::new("elight_sword_beam_m"), Hash40::new("sword1"), 0, 0, 0, 0, 90, 0, 1, true);
        macros::LAST_EFFECT_SET_OFFSET_TO_CAMERA_FLAT(fighter, -0.3);
        macros::EFFECT_FOLLOW(fighter, Hash40::new("elight_sword_light_few"), Hash40::new("sword1"), 0, 0, 0, 0, 0, 0, 1, true);
    }
    frame(fighter.lua_state_agent, 30.0);
    if macros::is_excute(fighter) {
        macros::EFFECT_FOLLOW(fighter, Hash40::new("elight_attack100_finish"), Hash40::new("top"), 0, 4, 8, 0, 0, 0, 0.4, true);
        macros::LAST_EFFECT_SET_RATE(fighter, 2.0);
    }
    frame(fighter.lua_state_agent, 42.0);
    if macros::is_excute(fighter) {
        macros::EFFECT_OFF_KIND(fighter, Hash40::new("elight_sword_light_few"), false, true);
    }
    frame(fighter.lua_state_agent, 43.0);
    if macros::is_excute(fighter) {
        macros::EFFECT_OFF_KIND(fighter, Hash40::new("elight_sword_beam_m"), true, true);
        macros::EFFECT_FOLLOW(fighter, Hash40::new("elight_sword_close_m"), Hash40::new("sword1"), 0, 0, 0, 0, 90, 0, 1, true);
        macros::LAST_EFFECT_SET_OFFSET_TO_CAMERA_FLAT(fighter, -0.3);
    }
}

#[acmd_script( agent = "elight", script = "sound_attackairlw", category = ACMD_SOUND )]
unsafe fn elight_attackairlw_snd(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 11.0);
    if macros::is_excute(fighter) {
        macros::PLAY_SE(fighter, Hash40::new("se_elight_attackair_l01"));
        macros::PLAY_SE(fighter, Hash40::new("vc_elight_attack01"));
    }
    frame(fighter.lua_state_agent, 29.0);
    if macros::is_excute(fighter) {
        macros::PLAY_SE(fighter, Hash40::new("se_elight_attack100_end"));
        macros::PLAY_SEQUENCE(fighter, Hash40::new("seq_elight_rnd_attack04"));
    }
}

#[acmd_script( agent = "elight", script = "expression_attackairlw", category = ACMD_EXPRESSION )]
unsafe fn elight_attackairlw_exp(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 13.0);
    if macros::is_excute(fighter) {
        macros::RUMBLE_HIT(fighter, Hash40::new("rbkind_79_lightairslash"), 0);
        ControlModule::set_rumble(
            fighter.module_accessor,
            Hash40::new("rbkind_nohits"),
            3,
...
#[acmd_script( agent = "elight", script = "game_landingairlw", category = ACMD_GAME )]
unsafe fn elight_landingairlw(fighter: &mut L2CAgentBase) {
...
#[acmd_script( agent = "elight", script = "effect_landingairlw", category = ACMD_EFFECT )]
unsafe fn elight_landingairlw_eff(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
...
#[acmd_script( agent = "elight", script = "sound_landingairlw", category = ACMD_SOUND )]
unsafe fn elight_landingairlw_snd(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 2.0);
    if macros::is_excute(fighter) {
        macros::PLAY_SE(fighter, Hash40::new("se_elight_landing02"));
    }
    if VarModule::is_flag(fighter.battle_object, elight::instance::flag::ATTACK_AIR_LW_LANDING_ATTACK) {
        if macros::is_excute(fighter) {
            macros::PLAY_SE(fighter, Hash40::new("se_elight_attack100_end"));
