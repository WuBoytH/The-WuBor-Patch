...
#[status_script(agent = "fox", status = FIGHTER_STATUS_KIND_ATTACK, condition = LUA_SCRIPT_STATUS_FUNC_STATUS_PRE)]
unsafe fn fox_attack_pre(fighter: &mut L2CFighterCommon) -> L2CValue {
