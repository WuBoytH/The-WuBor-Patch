...
#[acmd("gamewatch", "game_attackhi4r")]
...
pub fn install() {
    gamewatch_attacks4::install();
    gamewatch_attackhi4::install();
    gamewatch_attackhi4r::install();
    gamewatch_attacklw4::install();
}