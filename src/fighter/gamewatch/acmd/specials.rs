...
#[acmd_script( agent = "gamewatch", script = "game_specials2_sub", category = ACMD_GAME, low_priority )]
unsafe fn gamewatch_specials2_sub(agent: &mut L2CAgentBase) {
...
unsafe fn gamewatch_specials3_sub(agent: &mut L2CAgentBase) {
    if macros::is_excute(agent) {
...
#[acmd_script( agent = "gamewatch", script = "game_specials4_sub", category = ACMD_GAME, low_priority )]
unsafe fn gamewatch_specials4_sub(agent: &mut L2CAgentBase) {
    if macros::is_excute(agent) {
...
unsafe fn gamewatch_specials5_sub(agent: &mut L2CAgentBase) {
    for _ in 0..4 {
    if macros::is_excute(agent) {
...
#[acmd_script( agent = "gamewatch", script = "game_specials7_sub", category = ACMD_GAME, low_priority )]
unsafe fn gamewatch_specials7_sub(agent: &mut L2CAgentBase) {
    if macros::is_excute(agent) {
...
unsafe fn gamewatch_specials8_sub(agent: &mut L2CAgentBase) {
    if macros::is_excute(agent) {
...
unsafe fn gamewatch_specials9_sub(agent: &mut L2CAgentBase) {
    if macros::is_excute(agent) {
...
pub fn install() {
    install_acmd_scripts!(
        gamewatch_specials2_sub, gamewatch_specials3_sub, gamewatch_specials4_sub, gamewatch_specials5_sub,
        gamewatch_specials7_sub, gamewatch_specials8_sub, gamewatch_specials9_sub, 
        gamewatch_specialhi
    );
}