...
pub unsafe extern "C" fn jack_special_n_check_next(
    ...
    if ControlModule::check_button_on(fighter.module_accessor, *CONTROL_PAD_BUTTON_GUARD) {
        ...
        if WorkModule::is_flag(fighter.module_accessor, *FIGHTER_JACK_STATUS_SPECIAL_N_FLAG_CHECK_BUTTON_RAPID) {
            if fighter.global_table[SITUATION_KIND].get_i32() == *SITUATION_KIND_GROUND {
                ...
                && (
                    ...
                    fighter.change_status(FIGHTER_JACK_STATUS_KIND_SPECIAL_N_JUMP.into(), true.into());
                    return true.into();
                }
            }
        }
        ...
        if WorkModule::is_flag(fighter.module_accessor, *FIGHTER_JACK_STATUS_SPECIAL_N_FLAG_CHECK_BUTTON_RAPID) {
            if fighter.global_table[STATUS_KIND_INTERRUPT].get_i32() != *FIGHTER_JACK_STATUS_KIND_SPECIAL_N_ESCAPE {
