...
fn kamui_frame(fighter: &mut L2CFighterCommon) {
    unsafe {
        ...
        if VarModule::get_float(fighter.module_accessor, kamui::instance::float::DRAGON_INSTALL) > 0.0 {
            if !AttackModule::is_infliction(fighter.module_accessor, *COLLISION_KIND_MASK_HIT)
            && !AttackModule::is_infliction(fighter.module_accessor, *COLLISION_KIND_MASK_SHIELD) {
                VarModule::sub_float(fighter.module_accessor, kamui::instance::float::DRAGON_INSTALL, 1.0);
            }
            else if AttackModule::is_infliction(fighter.module_accessor, *COLLISION_KIND_MASK_HIT)
            || AttackModule::is_infliction(fighter.module_accessor, *COLLISION_KIND_MASK_SHIELD) {
                VarModule::add_float(fighter.module_accessor, kamui::instance::float::DRAGON_INSTALL, 2.0);
            }
        ...
        if VarModule::get_float(fighter.module_accessor, kamui::instance::float::DRAGON_INSTALL_TIMER) > 0.0 {
            if VarModule::get_float(fighter.module_accessor, kamui::instance::float::DRAGON_INSTALL_TIMER) == 24.0 {
            ...
            if VarModule::get_float(fighter.module_accessor, kamui::instance::float::DRAGON_INSTALL_TIMER) == 18.0 {
                macros::EFFECT_FOLLOW(fighter, Hash40::new("kamui_transform_splash_start"), Hash40::new("handr"), 2, 0, 0, 0, 0, 0, 0.7, true);
                macros::LAST_EFFECT_SET_RATE(fighter, 0.5);
            }
            VarModule::sub_float(fighter.module_accessor, kamui::instance::float::DRAGON_INSTALL_TIMER, 1.0);
            if VarModule::get_float(fighter.module_accessor, kamui::instance::float::DRAGON_INSTALL) > 0.0 {
                if VarModule::get_float(fighter.module_accessor, kamui::instance::float::DRAGON_INSTALL_TIMER) == 0.0 {
                    VarModule::set_float(fighter.module_accessor, kamui::instance::float::DRAGON_INSTALL_TIMER, 24.0);
                }
            }
        }
    }
