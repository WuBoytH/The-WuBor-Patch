...
pub unsafe fn kirby_jack_special_n_substatus_stick_check(fighter: &mut L2CFighterCommon) {
...
pub unsafe fn kirby_jack_special_n_check_next(
...
pub unsafe fn kirby_jack_special_n_landing_handler(fighter: &mut L2CFighterCommon, landing_frame: L2CValue) {
