...
pub unsafe extern "C" fn kirby_jack_special_n_jump_main(fighter: &mut L2CFighterCommon) -> L2CValue {
...
pub unsafe extern "C" fn kirby_jack_special_n_jump_check_next(
...
pub fn install(agent: &mut Agent) {
    agent.status(Main, *FIGHTER_KIRBY_STATUS_KIND_JACK_SPECIAL_N_JUMP, kirby_jack_special_n_jump_main);
}