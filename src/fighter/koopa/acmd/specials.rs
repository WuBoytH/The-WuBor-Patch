...
#[acmd("koopa", "game_specialsaircatch")]
...
pub fn install() {
    koopa_breath_move::install();
    koopa_breath_move_eff::install();
    koopa_breath_move_snd::install();

    koopa_specialscatch::install();

    koopa_specialsaircatch::install();

    koopa_specialairhi::install();
}