...
#[status("lucario", FIGHTER_STATUS_KIND_SPECIAL_N)]
...
#[status("lucario", FIGHTER_LUCARIO_STATUS_KIND_SPECIAL_N_HOLD)]
...
#[status("lucario", FIGHTER_LUCARIO_STATUS_KIND_SPECIAL_N_SHOOT)]
...
pub fn install() {
    lucario_special_n_main::install();
    lucario_special_n_end::install();
    lucario_special_n_hold_main::install();
    lucario_special_n_hold_end::install();
    lucario_special_n_shoot_main::install();
}