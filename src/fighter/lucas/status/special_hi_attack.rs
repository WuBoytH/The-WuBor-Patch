...
#[status("lucas", FIGHTER_LUCAS_STATUS_KIND_SPECIAL_HI_ATTACK)]
unsafe fn lucas_special_hi_attack_pre(fighter: &mut L2CFighterCommon) -> L2CValue {
...
pub fn install() {
    lucas_special_hi_attack_pre::install();
}