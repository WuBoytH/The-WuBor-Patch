...
unsafe fn lucina_reset_vars(fighter: &mut L2CFighterCommon) {
    if StatusModule::status_kind(fighter.module_accessor) == *FIGHTER_STATUS_KIND_REBIRTH {
        ...
        VarModule::set_int(fighter.module_accessor, yu::instance::int::SP_EFFECT_TIMER, 0);
        ...
        VarModule::off_flag(fighter.module_accessor, yu::instance::flag::AWAKENING);
...
unsafe fn lucina_meter_controller(fighter: &mut L2CFighterCommon) {
    ...
    || VarModule::is_flag(fighter.module_accessor, yu::instance::flag::SHADOW_FRENZY) {
        if VarModule::get_int(fighter.module_accessor, yu::instance::int::SP_GLOW_TIMER) == 0 {
            ...
            VarModule::set_int(fighter.module_accessor, yu::instance::int::SP_GLOW_TIMER, 4);
        }
        VarModule::dec_int(fighter.module_accessor, yu::instance::int::SP_GLOW_TIMER);
    }
}
...
unsafe fn lucina_normal_shadow_effects(fighter: &mut L2CFighterCommon) {
    if shadow_id(fighter.module_accessor) {
        ...
        if !EffectModule::is_exist_effect(fighter.module_accessor, eff) {
            ...
            VarModule::set_int(fighter.module_accessor, yu::instance::int::SHADOW_EFF_ID, eff as i32);
        }
        ...
        if VarModule::is_flag(fighter.module_accessor, yu::instance::flag::SHADOW_FRENZY) {
            ...
            VarModule::sub_float(fighter.module_accessor, yu::instance::float::SP_GAUGE, amount);
        }
        ...
        if DamageModule::damage(fighter.module_accessor, 0) >= vl::param_private::awakening_activation_damage {
            if !VarModule::is_flag(fighter.module_accessor, yu::instance::flag::AWAKENING)
            && StatusModule::situation_kind(fighter.module_accessor) == *SITUATION_KIND_GROUND
            && !MiscModule::is_damage_check(fighter.module_accessor, false)
            && sv_information::is_ready_go() {
                VarModule::set_float(fighter.module_accessor, yu::instance::float::SP_GAUGE_MAX, vl::param_private::awakening_sp_max);
                FGCModule::update_meter(fighter.module_accessor, vl::param_private::awakening_sp_gain, vl::param_private::awakening_sp_max, yu::instance::float::SP_GAUGE);
                VarModule::on_flag(fighter.module_accessor, yu::instance::flag::AWAKENING);
...
unsafe fn lucina_one_more_check(fighter: &mut L2CFighterCommon) {
    ...
    //     && !VarModule::is_flag(fighter.module_accessor, yu::status::flag::CAN_ONE_MORE) {
    //         VarModule::on_flag(fighter.module_accessor, yu::status::flag::CAN_ONE_MORE);
    //     }
    // }
    ...
    if fighter.global_table[STATUS_KIND_INTERRUPT].get_i32() != *FIGHTER_STATUS_KIND_SPECIAL_LW {
        ...
        && AttackModule::is_infliction_status(fighter.module_accessor, *COLLISION_KIND_MASK_HIT | *COLLISION_KIND_MASK_SHIELD) {
            VarModule::on_flag(fighter.module_accessor, yu::instance::flag::ROMAN_ON_HIT);
        }
        else {
            VarModule::off_flag(fighter.module_accessor, yu::instance::flag::ROMAN_ON_HIT);
        }
    }
...
unsafe fn lucina_sb_flash(fighter: &mut L2CFighterCommon) {
    if VarModule::get_int(fighter.module_accessor, yu::instance::int::SP_FLASH_TIMER) > 0 {
        ...
        else if VarModule::get_int(fighter.module_accessor, yu::instance::int::SP_FLASH_TIMER) % 5 == 0 {
            macros::COL_NORMAL(fighter);
        }
        VarModule::dec_int(fighter.module_accessor, yu::instance::int::SP_FLASH_TIMER);
    }
}
