...
unsafe fn lucina_reset_vars(fighter: &mut L2CFighterCommon) {
    if StatusModule::status_kind(fighter.module_accessor) == *FIGHTER_STATUS_KIND_REBIRTH {
        ...
        VarModule::set_int(fighter.battle_object, yu::instance::int::SP_GLOW_TIMER, 0);
        VarModule::set_int(fighter.battle_object, yu::instance::int::SP_EFFECT_TIMER, 0);
        VarModule::set_float(fighter.battle_object, yu::instance::float::SP_GAUGE_MAX, 100.0);
        VarModule::set_float(fighter.battle_object, yu::instance::float::SP_GAUGE, 0.0);
        VarModule::off_flag(fighter.battle_object, yu::instance::flag::AWAKENING);
        VarModule::off_flag(fighter.battle_object, yu::instance::flag::SHADOW_FRENZY);
    }
...
unsafe fn lucina_meter_controller(fighter: &mut L2CFighterCommon) {
    if VarModule::get_float(fighter.battle_object, yu::instance::float::SP_GAUGE) >= 25.0
    || VarModule::is_flag(fighter.battle_object, yu::instance::flag::SHADOW_FRENZY) {
        if VarModule::get_int(fighter.battle_object, yu::instance::int::SP_GLOW_TIMER) == 0 {
            sp_glow_handler(fighter.module_accessor);
            VarModule::set_int(fighter.battle_object, yu::instance::int::SP_GLOW_TIMER, 4);
        }
        VarModule::dec_int(fighter.battle_object, yu::instance::int::SP_GLOW_TIMER);
    }
}
...
unsafe fn lucina_meter_display(fighter: &mut L2CFighterCommon) {
    let level = VarModule::get_int(fighter.battle_object, yu::instance::int::SP_LEVEL);
    let sp = VarModule::get_float(fighter.battle_object, yu::instance::float::SP_GAUGE);
    let new_level = sp / vl::param_private::sp_single;
    if level != new_level as i32 {
        sp_diff_checker(fighter.module_accessor);
    }

    if VarModule::get_float(fighter.battle_object, yu::instance::float::SP_GAIN_PENALTY) > 0.0 {
        VarModule::sub_float(fighter.battle_object, yu::instance::float::SP_GAIN_PENALTY, 1.0);
    }

    if VarModule::get_int(fighter.battle_object, yu::instance::int::SP_EFFECT_TIMER) > 0 {
        VarModule::dec_int(fighter.battle_object, yu::instance::int::SP_EFFECT_TIMER);
        if VarModule::get_int(fighter.battle_object, yu::instance::int::SP_EFFECT_TIMER) == 0 {
...
unsafe fn lucina_normal_shadow_effects(fighter: &mut L2CFighterCommon) {
    if shadow_id(fighter.module_accessor) {
        let eff = VarModule::get_int(fighter.battle_object, yu::instance::int::SHADOW_EFF_ID) as u32;
        if !EffectModule::is_exist_effect(fighter.module_accessor, eff) {
            ...
            VarModule::set_int(fighter.battle_object, yu::instance::int::SHADOW_EFF_ID, eff as i32);
        }
        ...
        if VarModule::is_flag(fighter.battle_object, yu::instance::flag::SHADOW_FRENZY) {
            ...
            VarModule::sub_float(fighter.battle_object, yu::instance::float::SP_GAUGE, amount);
        }
        ...
        if DamageModule::damage(fighter.module_accessor, 0) >= vl::param_private::awakening_activation_damage {
            if !VarModule::is_flag(fighter.battle_object, yu::instance::flag::AWAKENING)
            && StatusModule::situation_kind(fighter.module_accessor) == *SITUATION_KIND_GROUND
            && !MiscModule::is_damage_check(fighter.module_accessor, false)
            && sv_information::is_ready_go() {
                VarModule::set_float(fighter.battle_object, yu::instance::float::SP_GAUGE_MAX, vl::param_private::awakening_sp_max);
                FGCModule::update_meter(fighter.battle_object, vl::param_private::awakening_sp_gain, vl::param_private::awakening_sp_max, yu::instance::float::SP_GAUGE);
                VarModule::on_flag(fighter.battle_object, yu::instance::flag::AWAKENING);
...
unsafe fn lucina_on_empty_sp_meter(fighter: &mut L2CFighterCommon) {
    if VarModule::get_float(fighter.battle_object, yu::instance::float::SP_GAUGE) <= 0.0 {
        VarModule::set_float(fighter.battle_object, yu::instance::float::SP_GAUGE, 0.0);
        VarModule::off_flag(fighter.battle_object, yu::instance::flag::SHADOW_FRENZY);
        sp_diff_checker(fighter.module_accessor);
    }
...
unsafe fn lucina_sb_flash(fighter: &mut L2CFighterCommon) {
    if VarModule::get_int(fighter.battle_object, yu::instance::int::SP_FLASH_TIMER) > 0 {
        if VarModule::get_int(fighter.battle_object, yu::instance::int::SP_FLASH_TIMER) % 10 == 0 {
            if VarModule::is_flag(fighter.battle_object, yu::instance::flag::SHADOW_FRENZY) {
        ...
        else if VarModule::get_int(fighter.battle_object, yu::instance::int::SP_FLASH_TIMER) % 5 == 0 {
            macros::COL_NORMAL(fighter);
        }
        VarModule::dec_int(fighter.battle_object, yu::instance::int::SP_FLASH_TIMER);
    }
}
