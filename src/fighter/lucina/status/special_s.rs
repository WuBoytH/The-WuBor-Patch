...
pub fn install(agent: &mut Agent) {
    ...
    agent.status(Pre, yu::status::SPECIAL_S_COMMAND, lucina_special_s_pre);
    agent.status(Init, yu::status::SPECIAL_S_COMMAND, lucina_special_s_command_init);
    agent.status(Main, yu::status::SPECIAL_S_COMMAND, lucina_special_s_command_main);
    agent.status(Exec, yu::status::SPECIAL_S_COMMAND, lucina_special_s_command_exec);
    agent.status(End, yu::status::SPECIAL_S_COMMAND, lucina_special_s_command_end);
}