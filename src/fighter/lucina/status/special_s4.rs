...
unsafe extern "C" fn lucina_specials4_pre(fighter: &mut L2CFighterCommon) -> L2CValue {
...
unsafe extern "C" fn lucina_specials4_main(fighter: &mut L2CFighterCommon) -> L2CValue {
