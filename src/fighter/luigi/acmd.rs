...
unsafe fn luigi_specialhi(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if macros::is_excute(fighter) {
        VarModule::off_flag(fighter.battle_object, luigi::instance::flag::SPECIAL_HI_CANCEL);
    }
    ...
    if AttackModule::is_infliction_status(fighter.module_accessor, *COLLISION_KIND_MASK_HIT) {
        VarModule::on_flag(fighter.battle_object, luigi::instance::flag::SPECIAL_HI_CANCEL);
    }
    if macros::is_excute(fighter) {
