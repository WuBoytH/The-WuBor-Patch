...
#[acmd("luigi", ["game_specialsend", "game_specialairsend"])]
...
#[acmd("luigi", ["effect_specialsend", "effect_specialairsend"])]
...
#[acmd("luigi", "game_specialairlw")]
unsafe fn luigi_specialairlw(agent: &mut L2CAgentBase) {
    frame(agent.lua_state_agent, 3.0);
    macros::FT_MOTION_RATE(agent, 3.0 / 7.0);
    frame(agent.lua_state_agent, 10.0);
    macros::FT_MOTION_RATE(agent, 1.0);
