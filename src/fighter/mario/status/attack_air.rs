...
unsafe extern "C" fn mario_attackair_end(fighter: &mut L2CFighterCommon) -> L2CValue {
...
unsafe extern "C" fn mario_landingattackair_end(fighter: &mut L2CFighterCommon) -> L2CValue {
