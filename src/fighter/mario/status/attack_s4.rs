...
unsafe extern "C" fn mario_attacks4_start_end(fighter: &mut L2CFighterCommon) -> L2CValue {
...
unsafe extern "C" fn mario_attacks4_hold_end(fighter: &mut L2CFighterCommon) -> L2CValue {
...
unsafe extern "C" fn mario_attacks4_end(fighter: &mut L2CFighterCommon) -> L2CValue {
    mario_remove_hammer(fighter);
    0.into()
}
