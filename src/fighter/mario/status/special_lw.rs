...
unsafe extern "C" fn mario_special_lw_main(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    if fighter.global_table[SITUATION_KIND].get_i32() == *SITUATION_KIND_GROUND {
        ...
        VarModule::off_flag(fighter.module_accessor, mario::instance::flag::SPECIAL_LW_BLJ_PREV);
        VarModule::set_int(fighter.module_accessor, mario::instance::int::SPECIAL_LW_KIND, mario::SPECIAL_LW_KIND_GROUND_POUND);
...
unsafe extern "C" fn mario_special_lw_shoot_init(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    if VarModule::get_int(fighter.module_accessor, mario::instance::int::SPECIAL_LW_KIND) == mario::SPECIAL_LW_KIND_LONG_JUMP {
        VarModule::off_flag(fighter.module_accessor, mario::status::flag::SPECIAL_LW_BLJ);
        ...
        if [6, 3, 9].contains(&dir) {
            ...
            VarModule::set_int(fighter.module_accessor, mario::status::int::SPECIAL_LW_LONG_JUMP_KIND, mario::LONG_JUMP_S);
            VarModule::off_flag(fighter.module_accessor, mario::instance::flag::SPECIAL_LW_BLJ_PREV);
        }
        else if [4, 7, 1].contains(&dir) {
            VarModule::on_flag(fighter.module_accessor, mario::status::flag::SPECIAL_LW_BLJ);
            if VarModule::is_flag(fighter.module_accessor, mario::instance::flag::SPECIAL_LW_BLJ_PREV) {
                speed_x = -vl::param_special_lw::long_jump_speed_strong_x;
                speed_y = 0.0;
                VarModule::set_int(fighter.module_accessor, mario::status::int::SPECIAL_LW_LONG_JUMP_KIND, mario::LONG_JUMP_B);
            }
            else {
                speed_x = vl::param_special_lw::long_jump_speed_weak_x;
                speed_y = vl::param_special_lw::long_jump_speed_weak_y;
                VarModule::set_int(fighter.module_accessor, mario::status::int::SPECIAL_LW_LONG_JUMP_KIND, mario::LONG_JUMP_W);
            }
            VarModule::on_flag(fighter.module_accessor, mario::instance::flag::SPECIAL_LW_BLJ_PREV);
        }
        else {
            speed_x = vl::param_special_lw::long_jump_speed_mid_x;
            speed_y = vl::param_special_lw::long_jump_speed_mid_y;
                VarModule::set_int(fighter.module_accessor, mario::status::int::SPECIAL_LW_LONG_JUMP_KIND, mario::LONG_JUMP_M);
            VarModule::off_flag(fighter.module_accessor, mario::instance::flag::SPECIAL_LW_BLJ_PREV);
        }
