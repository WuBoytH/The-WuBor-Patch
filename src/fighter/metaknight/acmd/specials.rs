...
#[acmd("metaknight", ["game_specialnstart", "game_specialairnstart"])]
...
#[acmd("metaknight", ["effect_specialnstart", "effect_specialairnstart"])]
...
#[acmd("metaknight", "game_specialnspin")]
...
#[acmd("metaknight", "game_specialhi")]
...
#[acmd("metaknight", "game_specialhiloop")]
...
pub fn install() {
    metaknight_specialnstart::install();
    metaknight_specialnstart_eff::install();
    metaknight_specialnspin::install();
    metaknight_specialhi::install();
    metaknight_specialhiloop::install();
}
