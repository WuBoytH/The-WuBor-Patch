...
#[acmd_script( agent = "miiagent", script = "game_escapeairslide", category = ACMD_GAME, low_priority )]
unsafe fn miiagent_escapeairslide(agent: &mut L2CAgentBase) {
