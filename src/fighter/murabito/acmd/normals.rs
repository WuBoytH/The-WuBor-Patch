...
pub fn install(agent: &mut smashline::Agent) {
    agent.acmd("game_attack11", game_attack1x);

    agent.acmd("game_attack12", game_attack1x);

    agent.acmd("game_attack11end", game_attack1xend);

    agent.acmd("game_attack12end", game_attack1xend);
