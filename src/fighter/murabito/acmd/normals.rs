...
pub fn install() {
    murabito_attackdash::install();
    murabito_attacks3::install();
    murabito_attackhi3::install();
    murabito_attacklw3::install();
}