...
#[acmd("palutena", "game_attackairn")]
unsafe fn palutena_attackairn(agent: &mut L2CAgentBase) {
...
#[acmd("palutena", "game_attackairb")]
unsafe fn palutena_attackairb(agent: &mut L2CAgentBase) {
...
pub fn install() {
    palutena_attackairn::install();
    palutena_attackairb::install();
}
