...
#[status("pikachu", FIGHTER_STATUS_KIND_SPECIAL_S)]
...
pub fn install() {
    pikachu_special_s_pre::install();
    pikachu_special_s_init::install();
    pikachu_special_s_main::install();
    pikachu_special_s_exec::install();
    pikachu_special_s_end::install();
}