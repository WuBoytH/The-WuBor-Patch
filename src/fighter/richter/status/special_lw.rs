...
unsafe extern "C" fn richter_special_lw_pre(fighter: &mut L2CFighterCommon) -> L2CValue {
...
unsafe extern "C" fn richter_special_lw_main(fighter: &mut L2CFighterCommon) -> L2CValue {
...
unsafe extern "C" fn richter_special_lw_end(fighter: &mut L2CFighterCommon) -> L2CValue {
