...
unsafe extern "C" fn ridley_catchattack(agent: &mut L2CAgentBase) {
...
unsafe extern "C" fn ridley_catchattack_eff(agent: &mut L2CAgentBase) {
...
pub fn install(agent: &mut smashline::Agent) {
    agent.game_acmd("game_catchattack", ridley_catchattack);
    agent.effect_acmd("effect_catchattack", ridley_catchattack_eff);
    agent.sound_acmd("sound_catchattack", ridley_catchattack_snd);
}