...
pub fn install(agent: &mut Agent) {
    agent.status(Pre, *FIGHTER_ROCKMAN_STATUS_KIND_ROCKBUSTER_SHOOT_JUMP_SQUAT, rockman_rockbuster_shoot_jump_squat_pre);
    agent.status(Main, *FIGHTER_ROCKMAN_STATUS_KIND_ROCKBUSTER_SHOOT_JUMP_SQUAT, rockman_rockbuster_shoot_jump_squat_main);
}