...
unsafe extern "C" fn ryu_specialairsstart(agent: &mut L2CAgentBase) {
    frame(agent.lua_state_agent, 7.0);
    if macros::is_excute(agent) {
        FighterAreaModuleImpl::enable_fix_jostle_area_xy(agent.module_accessor, 1.0, 3.5, 8.5, 8.5);
    }
...
unsafe extern "C" fn ryu_specialairs(agent: &mut L2CAgentBase) {
    if macros::is_excute(agent) {
...
unsafe extern "C" fn ryu_hadoken_movew(agent: &mut L2CAgentBase) {
    if macros::is_excute(agent) {
...
unsafe extern "C" fn ryu_hadoken_movem(agent: &mut L2CAgentBase) {
    if macros::is_excute(agent) {
...
unsafe extern "C" fn ryu_hadoken_moves(agent: &mut L2CAgentBase) {
    if macros::is_excute(agent) {
