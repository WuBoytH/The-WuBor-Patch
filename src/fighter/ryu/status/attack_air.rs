...
#[status_script(agent = "ryu", status = FIGHTER_STATUS_KIND_ATTACK_AIR, condition = LUA_SCRIPT_STATUS_FUNC_STATUS_MAIN)]
unsafe fn ryu_attack_air_main(fighter: &mut L2CFighterCommon) -> L2CValue {
