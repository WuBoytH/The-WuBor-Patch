...
unsafe extern "C" fn game_specialairshold_inner(agent: &mut L2CAgentBase) {
    if macros::is_excute(agent) {
        ...
        if status
        && last {
            macros::ATTACK(agent, 0, 0, Hash40::new("top"), 0.5, 85, 100, 30, 30, 4.0, 0.0, 8.0, 6.0, Some(0.0), Some(8.0), Some(7.0), 0.1, 0.2, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_F, true, -5, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_rush"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
        }
        else {
            macros::ATTACK(agent, 0, 0, Hash40::new("top"), 0.5, 368, 100, 10, 30, 4.0, 0.0, 8.0, 6.0, Some(0.0), Some(8.0), Some(7.0), 0.1, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, true, -5, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_rush"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
            AttackModule::set_vec_target_pos(agent.module_accessor, 0, Hash40::new("top"), &Vector2f{x: 10.0, y: 6.0}, 6, false);
        }
    }
