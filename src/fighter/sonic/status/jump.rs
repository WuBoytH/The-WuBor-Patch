...
#[status("sonic", FIGHTER_STATUS_KIND_JUMP_AERIAL)]
...
#[status("sonic", FIGHTER_STATUS_KIND_ITEM_SCREW_JUMP_AERIAL)]
...
pub fn install() {
    sonic_jumpaerial_main::install();
    sonic_screwjumpaerial_main::install();
}