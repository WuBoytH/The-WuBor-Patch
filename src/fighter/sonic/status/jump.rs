...
unsafe extern "C" fn sonic_jumpaerial_main(fighter: &mut L2CFighterCommon) -> L2CValue {
...
unsafe extern "C" fn sonic_screwjumpaerial_main(fighter: &mut L2CFighterCommon) -> L2CValue {
