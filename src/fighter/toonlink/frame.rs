...
fn toonlink_frame(fighter: &mut L2CFighterCommon) {
    unsafe {
        ...
        if MotionModule::motion_kind(fighter.module_accessor) == hash40("attack_air_lw") {
            ...
            if VarModule::is_flag(fighter.battle_object, toonlink::status::flag::ATTACK_AIR_LW_BOUNCE) {
                ...
                && MotionModule::frame(fighter.module_accessor) < 65.0 {
                    ...
                    VarModule::off_flag(fighter.battle_object, toonlink::status::flag::ATTACK_AIR_LW_BOUNCE);
