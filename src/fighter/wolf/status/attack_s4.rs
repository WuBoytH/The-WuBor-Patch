...
#[status_script(agent = "wolf", status = FIGHTER_STATUS_KIND_ATTACK_S4, condition = LUA_SCRIPT_STATUS_FUNC_STATUS_PRE)]
unsafe fn wolf_attack_s4_pre(fighter: &mut L2CFighterCommon) -> L2CValue {
