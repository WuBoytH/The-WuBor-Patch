...
pub unsafe fn spent_meter(boma: &mut BattleObjectModuleAccessor, onemore: bool) -> bool {
    let mut spent = false;
    if SP_GAUGE[entry_id(boma)] > 0.0 {
        if SHADOW_FRENZY[entry_id(boma)] {
            if onemore {
                SPENT_SP[entry_id(boma)] = 12.5;
                spent = true;
            }
            else {
                SPENT_SP[entry_id(boma)] = 6.25;
                spent = true;
            }
        }
        else if SP_GAUGE[entry_id(boma)] >= 25.0 {
            SPENT_SP[entry_id(boma)] = 25.0;
            spent = true;
        }
    }
    return spent;
...
//     let entry_id(boma) = WorkModule::get_int(boma, *FIGHTER_INSTANCE_WORK_ID_INT_entry_id(boma)) as usize;
    ...
    unsafe {
        ...
        if entry_id(boma) < 8 {
            ...
            if StatusModule::status_kind(boma) == *FIGHTER_STATUS_KIND_REBIRTH {
                AIR_ACTION[entry_id(boma)] = false;
                _TIME_COUNTER[entry_id(boma)] = 0;
                if shadow_id(boma) {
                    if SHADOW_FRENZY[entry_id(boma)] {
                        SP_GAUGE[entry_id(boma)] = SP_GAUGE[entry_id(boma)] / 2.0;
                        SHADOW_FRENZY[entry_id(boma)] = false;
                    }
                }
                else {
                    SP_GAUGE_MAX[entry_id(boma)] = 100.0;
                    SP_GAUGE[entry_id(boma)] = 0.0;
                    AWAKENING[entry_id(boma)] = false;
                }
            }
            if sv_information::is_ready_go() == false {
                ...
                SHADOW_FRENZY[entry_id(boma)] = false;
                _TIME_COUNTER[entry_id(boma)] = 0;
                if !(smashball::is_training_mode() && TRAINING_TOOLS[entry_id(boma)]) {
                    SP_GAUGE[entry_id(boma)] = 0.0;
                    AWAKENING[entry_id(boma)] = false;
                    TRAINING_TOOLS[entry_id(boma)] = false;
                    SP_GAUGE_MAX[entry_id(boma)] = 100.0;
                    DAMAGE_TAKEN[entry_id(boma)] = 0.0;
                    DAMAGE_TAKEN_PREV[entry_id(boma)] = 0.0;
                }
            }
            ...
            && SHADOW_FRENZY[entry_id(boma)] == false {
                SP_GAUGE[entry_id(boma)] += (DAMAGE_TAKEN[entry_id(boma)] - DAMAGE_TAKEN_PREV[entry_id(boma)]) * (1.0/6.0);
            }
            DAMAGE_TAKEN_PREV[entry_id(boma)] = DAMAGE_TAKEN[entry_id(boma)];

            if AttackModule::is_infliction(boma, *COLLISION_KIND_MASK_HIT) && SHADOW_FRENZY[entry_id(boma)] == false {
                if StatusModule::status_kind(boma) != *FIGHTER_MARTH_STATUS_KIND_SPECIAL_N_END_MAX
                && StatusModule::status_kind(boma) != *FIGHTER_STATUS_KIND_SPECIAL_S
                && StatusModule::status_kind(boma) != *FIGHTER_MARTH_STATUS_KIND_SPECIAL_S2
                && StatusModule::status_kind(boma) != *FIGHTER_STATUS_KIND_SPECIAL_HI {
                    IS_EX[entry_id(boma)] = false;
                }
                if IS_EX[entry_id(boma)] == false {
                    METER_GAIN[entry_id(boma)] = AttackModule::get_power(boma, 0, false, 1.0, false);
                    if shadow_id(boma) == false {
                        METER_GAIN[entry_id(boma)] *= 0.75;
                    }
                    if IS_FUNNY[entry_id(boma)] {
                        METER_GAIN[entry_id(boma)] *= 3.0;
                    }
                    SP_GAUGE[entry_id(boma)] += METER_GAIN[entry_id(boma)];
                }
            }

            if SP_GAUGE[entry_id(boma)] > SP_GAUGE_MAX[entry_id(boma)] {
                SP_GAUGE[entry_id(boma)] = SP_GAUGE_MAX[entry_id(boma)];
            }
            ...
            if shadow_id(boma) == true {
                ...
                DMG_RATIO[entry_id(boma)] = 0.8;
                if SHADOW_FRENZY[entry_id(boma)] == true {
                    if !TRAINING_TOOLS[entry_id(boma)] {
                        if IS_FUNNY[entry_id(boma)] {
                            SP_GAUGE[entry_id(boma)] -= 1.0/64.0;
                        }
                        else {
                            SP_GAUGE[entry_id(boma)] -= 1.0/16.0;
                        }
                    }
                }
                ...
                DMG_RATIO[entry_id(boma)] = 1.0;
                if DamageModule::damage(boma, 0) >= 100.0 {
                    if AWAKENING[entry_id(boma)] == false
                    && StatusModule::situation_kind(boma) == *SITUATION_KIND_GROUND
                    && (!is_damage_check(boma)
                    || IS_FUNNY[entry_id(boma)])
                    && sv_information::is_ready_go() {
                        DamageModule::set_damage_mul(boma, 0.8);
                        SP_GAUGE_MAX[entry_id(boma)] = 150.0;
                        SP_GAUGE[entry_id(boma)] += 50.0;
                        AWAKENING[entry_id(boma)] = true;
            ...
            if StatusModule::prev_status_kind(boma, 0) != StatusModule::status_kind(boma) {
                CAN_ONE_MORE[entry_id(boma)] = false;
            }
            ...
            if StatusModule::status_kind(boma) != *FIGHTER_STATUS_KIND_SPECIAL_LW {
                ...
                && (MotionModule::motion_kind(boma) != hash40("special_hi") || IS_FUNNY[entry_id(boma)]) {
                    CAN_ONE_MORE[entry_id(boma)] = true;
                }
    
                if CAN_ONE_MORE[entry_id(boma)] == true {
                    if ControlModule::get_command_flag_cat(boma, 0) & *FIGHTER_PAD_CMD_CAT1_FLAG_SPECIAL_LW != 0 {
                        if spent_meter(boma, true) {
                            ROMAN_ON_HIT[entry_id(boma)] = true;
                    ...
                    if MotionModule::frame(boma) > throwframe && CAN_ONE_MORE[entry_id(boma)] == false {
                        CAN_ONE_MORE[entry_id(boma)] = true;
                    }
                    if CAN_ONE_MORE[entry_id(boma)] == true {
                        if ControlModule::get_command_flag_cat(boma, 0) & *FIGHTER_PAD_CMD_CAT1_FLAG_SPECIAL_LW != 0 {
                ...
                || IS_FUNNY[entry_id(boma)] {
                    if ControlModule::get_command_flag_cat(boma, 0) & *FIGHTER_PAD_CMD_CAT1_FLAG_SPECIAL_LW != 0 {
                        if spent_meter(boma, true) {
                            ROMAN_ON_HIT[entry_id(boma)] = false;
                            fighter.change_status(FIGHTER_STATUS_KIND_SPECIAL_LW.into(), false.into());
                        }
                    }
                }
            ...
            if StatusModule::status_kind(boma) != *FIGHTER_STATUS_KIND_SPECIAL_LW {
                IS_ROMAN_MOVE[entry_id(boma)] = false;
            }
            else {
            ...
            if IS_ROMAN_MOVE[entry_id(boma)] {
                PostureModule::add_pos_2d(boma, &Vector2f{
                    x: ROMAN_MOVE[entry_id(boma)],
                    y: 0.0
                });
                ROMAN_MOVE[entry_id(boma)] *= 0.9;
            }

            // Meter Effects

            if (SP_GAUGE[entry_id(boma)] >= 25.0 && SHADOW_FRENZY[entry_id(boma)] == false)
            || SHADOW_FRENZY[entry_id(boma)] == true {
                if _TIME_COUNTER[entry_id(boma)] == 0 {
                    ...
                    _TIME_COUNTER[entry_id(boma)] = 4;
                }
                _TIME_COUNTER[entry_id(boma)] -= 1;
            }

            if EX_FLASH[entry_id(boma)] > 0 {
                if EX_FLASH[entry_id(boma)] % 10 == 0 {
                    if SHADOW_FRENZY[entry_id(boma)] {
                ...
                else if EX_FLASH[entry_id(boma)] % 5 == 0 {
                    macros::COL_NORMAL(fighter);
                }
                EX_FLASH[entry_id(boma)] -= 1;
            }
            ...
            if MotionModule::motion_kind(boma) == hash40("appeal_hi_l") || MotionModule::motion_kind(boma) == hash40("appeal_hi_r") {
                if SP_GAUGE[entry_id(boma)] == 100.0 && shadow_id(boma) && ControlModule::check_button_on(boma, *CONTROL_PAD_BUTTON_SPECIAL) {
                    SHADOW_FRENZY[entry_id(boma)] = true;
                }
            }
            else if SP_GAUGE[entry_id(boma)] == 0.0 {
                SHADOW_FRENZY[entry_id(boma)] = false;
            }
            ...
            && StatusModule::status_kind(boma) != *FIGHTER_STATUS_KIND_THROW {
                HEROIC_GRAB[entry_id(boma)] = false;
            }
            ...
            || (MotionModule::motion_kind(boma) == hash40("attack_dash")
            && IS_FUNNY[entry_id(boma)]) {
                if AttackModule::is_infliction_status(boma, *COLLISION_KIND_MASK_HIT) {
            ...
            if smashball::is_training_mode(){
                if ControlModule::check_button_on_trriger(boma, *CONTROL_PAD_BUTTON_APPEAL_S_L) {
                    if SP_GAUGE[entry_id(boma)] > 25.0 {
                ...
                if ControlModule::check_button_on_trriger(boma, *CONTROL_PAD_BUTTON_APPEAL_S_R) {
                    if SP_GAUGE[entry_id(boma)] < SP_GAUGE_MAX[entry_id(boma)] - 25.0 {
                        SP_GAUGE[entry_id(boma)] += 25.0
                    }
                    else {
                        SP_GAUGE[entry_id(boma)] = SP_GAUGE_MAX[entry_id(boma)];
                ...
                if ControlModule::check_button_on_trriger(boma, *CONTROL_PAD_BUTTON_APPEAL_LW) {
                    if TRAINING_TOOLS[entry_id(boma)] {
                        ...
                        TRAINING_TOOLS[entry_id(boma)] = true;
                        let pos = Vector3f{x: 0.0, y: 13.0, z: 0.0};
                        let rot = Vector3f{x: 0.0, y: 90.0, z: 0.0};
                        let onemoreeff: u32 = EffectModule::req_follow(boma, smash::phx::Hash40{hash: hash40("sys_counter_flash")}, smash::phx::Hash40{hash: hash40("top")}, &pos, &rot, 1.0, false, 0, 0, 0, 0, 0, false, false) as u32;
...
unsafe extern "C" fn lucina_specialnloopmainsub(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    && spent_meter(boma, false) {
        SP_GAUGE[entry_id(boma)] -= SPENT_SP[entry_id(boma)];
        EX_FLASH[entry_id(boma)] = 40;
        ...
        if MotionModule::is_end(boma) {
            if fighter.global_table[SITUATION_KIND].get_i32() == *SITUATION_KIND_AIR {
                ...
                HEROIC_GRAB[entry_id(boma)] = true;
...
unsafe fn lucina_specialsmain(fighter: &mut L2CFighterCommon) -> L2CValue {
    let boma = sv_system::battle_object_module_accessor(fighter.lua_state_agent);
    WorkModule::off_flag(boma, *FIGHTER_MARTH_STATUS_SPECIAL_S_FLAG_CONTINUE_MOT);
    KineticModule::change_kinetic(boma, *FIGHTER_KINETIC_TYPE_RESET);
    if fighter.global_table[SITUATION_KIND].get_i32() == *SITUATION_KIND_AIR {
        START_SITUATION[entry_id(boma)] = *SITUATION_KIND_AIR;
        KineticModule::change_kinetic(boma, *FIGHTER_KINETIC_TYPE_FALL);
        AIR_ACTION[entry_id(boma)] = true;
        MotionModule::change_motion(boma, Hash40::new("special_air_s1"), 1.0, 1.0, false, 0.0, false, false);
    }
    else {
        START_SITUATION[entry_id(boma)] = *SITUATION_KIND_GROUND;
        KineticModule::change_kinetic(boma, *FIGHTER_KINETIC_TYPE_MOTION);
        MotionModule::change_motion(boma, Hash40::new("special_s1"), 1.0, 1.0, false, 0.0, false, false);
    }
...
unsafe extern "C" fn lucina_specialsmainsub(fighter: &mut L2CFighterCommon) -> L2CValue {
    let boma = sv_system::battle_object_module_accessor(fighter.lua_state_agent);
    if START_SITUATION[entry_id(boma)] == *SITUATION_KIND_AIR
    && fighter.global_table[SITUATION_KIND].get_i32() == *SITUATION_KIND_GROUND {
        fighter.change_status(FIGHTER_STATUS_KIND_LANDING_FALL_SPECIAL.into(), false.into());
    }
    else if START_SITUATION[entry_id(boma)] == *SITUATION_KIND_GROUND
...
unsafe fn lucina_jab2(fighter: &mut L2CAgentBase) {
    ...
    if macros::is_excute(fighter) {
        macros::ATTACK(fighter, 0, 0, Hash40::new("kneer"), 4.5 * DMG_RATIO[entry_id(boma)], 361, 88, 0, 30, 4.2, 5.0, -1.0, 1.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
        macros::ATTACK(fighter, 1, 0, Hash40::new("kneer"), 4.5 * DMG_RATIO[entry_id(boma)], 361, 88, 0, 30, 3.8, -1.0, 0.0, 1.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
    }
...
unsafe fn lucina_ftilt(fighter: &mut L2CAgentBase) {
    ...
    if macros::is_excute(fighter) {
        macros::ATTACK(fighter, 0, 0, Hash40::new("sword1"), 10.0 * DMG_RATIO[entry_id(boma)], 361, 75, 0, 50, 3.5, 1.0, 0.0, 2.5, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
        macros::ATTACK(fighter, 1, 0, Hash40::new("armr"), 10.0 * DMG_RATIO[entry_id(boma)], 361, 75, 0, 50, 3.0, 0.0, 1.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
        macros::ATTACK(fighter, 2, 0, Hash40::new("sword1"), 10.0 * DMG_RATIO[entry_id(boma)], 361, 75, 0, 50, 3.5, 1.0, 0.0, 7.7, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
    }
...
unsafe fn lucina_utilt(fighter: &mut L2CAgentBase) {
    ...
    if macros::is_excute(fighter) {
        AttackModule::clear_all(boma);
        macros::ATTACK(fighter, 0, 0, Hash40::new("sword1"), 5.5 * DMG_RATIO[entry_id(boma)], 75, 60, 0, 65, 2.0, 0.0, -1.0, 1.0, Some(1.0), Some(0.0), Some(12.0), 1.0, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
    }
    sv_animcmd::frame(lua_state, 9.0);
    if macros::is_excute(fighter) {
        macros::ATTACK(fighter, 0, 0, Hash40::new("sword1"), 5.5 * DMG_RATIO[entry_id(boma)], 75, 60, 0, 65, 2.0, 0.0, -1.0, 1.0, Some(1.0), Some(-1.0), Some(12.0), 1.0, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
    }
...
unsafe fn lucina_dtilt(fighter: &mut L2CAgentBase) {
    ...
    sv_animcmd::frame(lua_state, 7.0);
    if macros::is_excute(fighter) {
        macros::ATTACK(fighter, 0, 0, Hash40::new("top"), 6.0 * DMG_RATIO[entry_id(boma)], 71, 40, 0, 57, 2.7, 0.0, 2.7, 16.700001, Some(0.0), Some(4.3), Some(9.2), 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.2, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_sting"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
        macros::ATTACK(fighter, 1, 0, Hash40::new("sword1"), 6.0 * DMG_RATIO[entry_id(boma)], 71, 40, 0, 57, 2.7, 0.0, 0.0, 8.2, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.2, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_sting"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
...
unsafe fn lucina_dashattack(fighter: &mut L2CAgentBase) {
    ...
    sv_animcmd::frame(lua_state, 7.0);
    if macros::is_excute(fighter) {
        macros::ATTACK(fighter, 0, 0, Hash40::new("kneer"), 7.0 * DMG_RATIO[entry_id(boma)], 65, 85, 0, 65, 3.6, 5.0, -1.0, 1.5, Some(1.5), Some(-1.0), Some(1.5), 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.2, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
        macros::ATTACK(fighter, 1, 0, Hash40::new("top"), 6.0 * DMG_RATIO[entry_id(boma)], 65, 85, 0, 65, 2.5, 0.0, 2.5, -2.6, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.2, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
        AttackModule::set_attack_height_all(boma, AttackHeight(*ATTACK_HEIGHT_LOW), false);
...
unsafe fn lucina_nair(fighter: &mut L2CAgentBase) {
    ...
    if macros::is_excute(fighter) {
        macros::ATTACK(fighter, 0, 0, Hash40::new("kneer"), 4.5 * DMG_RATIO[entry_id(boma)], 55, 60, 0, 40, 5.0, 3.5, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_A, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
        macros::ATTACK(fighter, 1, 0, Hash40::new("kneer"), 4.5 * DMG_RATIO[entry_id(boma)], 55, 60, 0, 40, 5.0, -2.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_A, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
        macros::ATTACK(fighter, 2, 0, Hash40::new("kneel"), 4.5 * DMG_RATIO[entry_id(boma)], 55, 60, 0, 40, 3.0, 1.5, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_A, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
        macros::ATTACK(fighter, 3, 0, Hash40::new("kneer"), 4.5 * DMG_RATIO[entry_id(boma)], 361, 60, 0, 40, 5.0, 3.5, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_G, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
        macros::ATTACK(fighter, 4, 0, Hash40::new("kneer"), 4.5 * DMG_RATIO[entry_id(boma)], 361, 60, 0, 40, 5.0, -2.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_G, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
        macros::ATTACK(fighter, 5, 0, Hash40::new("kneel"), 4.5 * DMG_RATIO[entry_id(boma)], 361, 60, 0, 40, 3.0, 1.5, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_G, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
    }
...
unsafe fn lucina_fair(fighter: &mut L2CAgentBase) {
    ...
    macros::FT_MOTION_RATE(fighter, 1.0);
    if macros::is_excute(fighter) {
        macros::ATTACK(fighter, 0, 0, Hash40::new("sword1"), 10.0 * DMG_RATIO[entry_id(boma)], 361, 75, 0, 50, 3.0, 1.0, 0.0, 3.5, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
        macros::ATTACK(fighter, 1, 0, Hash40::new("armr"), 10.0 * DMG_RATIO[entry_id(boma)], 361, 75, 0, 50, 3.8, 1.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
        macros::ATTACK(fighter, 2, 0, Hash40::new("sword1"), 10.0 * DMG_RATIO[entry_id(boma)], 361, 75, 0, 50, 3.0, 1.0, 0.0, 7.5, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
    }
    sv_animcmd::wait(lua_state, 4.0);
    if macros::is_excute(fighter) {
        AttackModule::clear_all(boma);
...
unsafe fn lucina_bair(fighter: &mut L2CAgentBase) {
    ...
    macros::FT_MOTION_RATE(fighter, 1.0);
    if macros::is_excute(fighter) {
        macros::ATTACK(fighter, 0, 0, Hash40::new("sword1"), 10.0 * DMG_RATIO[entry_id(boma)], 361, 75, 0, 50, 3.5, 0.0, 0.0, 3.7, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
        macros::ATTACK(fighter, 1, 0, Hash40::new("armr"), 10.0 * DMG_RATIO[entry_id(boma)], 361, 75, 0, 50, 3.5, 2.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
        macros::ATTACK(fighter, 2, 0, Hash40::new("sword1"), 10.0 * DMG_RATIO[entry_id(boma)], 361, 75, 0, 50, 3.5, 0.0, 0.0, 7.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
    }
...
unsafe fn lucina_uair(fighter: &mut L2CAgentBase) {
    ...
    sv_animcmd::frame(lua_state, 5.0);
    if macros::is_excute(fighter) {
        macros::ATTACK(fighter, 0, 0, Hash40::new("sword1"), 8.0 * DMG_RATIO[entry_id(boma)], 55, 40, 0, 40, 3.5, 1.0, 0.0, 2.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
        macros::ATTACK(fighter, 1, 0, Hash40::new("armr"), 8.0 * DMG_RATIO[entry_id(boma)], 55, 40, 0, 40, 3.0, 0.0, 1.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
        macros::ATTACK(fighter, 2, 0, Hash40::new("colonells"), 8.0 * DMG_RATIO[entry_id(boma)], 55, 40, 0, 40, 2.0, 0.0, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
        macros::ATTACK(fighter, 3, 0, Hash40::new("sword1"), 8.0 * DMG_RATIO[entry_id(boma)], 55, 40, 0, 40, 3.5, 1.0, 0.0, 6.7, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
    }
...
unsafe fn lucina_dair(fighter: &mut L2CAgentBase) {
    ...
    sv_animcmd::frame(lua_state, 9.0);
    if macros::is_excute(fighter) {
        macros::ATTACK(fighter, 0, 0, Hash40::new("armr"), 8.0 * DMG_RATIO[entry_id(boma)], 73, 75, 0, 30, 3.0, 0.0, 1.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
        macros::ATTACK(fighter, 1, 0, Hash40::new("sword1"), 8.0 * DMG_RATIO[entry_id(boma)], 73, 75, 0, 30, 3.5, 1.0, 0.0, 2.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
        macros::ATTACK(fighter, 2, 0, Hash40::new("sword1"), 8.0 * DMG_RATIO[entry_id(boma)], 73, 75, 0, 30, 3.5, 1.0, 0.0, 6.7, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
    }
...
unsafe fn lucina_usmash(fighter: &mut L2CAgentBase) {
    ...
    sv_animcmd::frame(lua_state, 13.0);
    if macros::is_excute(fighter) {
        macros::ATTACK(fighter, 1, 0, Hash40::new("sword1"), 12.0 * DMG_RATIO[entry_id(boma)], 89, 90, 0, 42, 5.8, 0.0, 0.0, 2.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_sting"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
        macros::ATTACK(fighter, 2, 0, Hash40::new("sword1"), 12.0 * DMG_RATIO[entry_id(boma)], 89, 90, 0, 42, 4.6, 0.0, 0.0, 7.3, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_sting"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
        macros::ATTACK(fighter, 0, 0, Hash40::new("sword1"), 12.0 * DMG_RATIO[entry_id(boma)], 89, 90, 0, 42, 5.8, 0.0, 0.0, -3.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_sting"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
...
unsafe fn lucina_uthrow(fighter: &mut L2CAgentBase) {
    ...
    sv_animcmd::frame(lua_state, 13.0);
    if macros::is_excute(fighter) {
        if HEROIC_GRAB[entry_id(boma)] == false {
            macros::ATK_HIT_ABS(fighter, *FIGHTER_ATTACK_ABSOLUTE_KIND_THROW, Hash40::new("throw"), WorkModule::get_int64(boma,*FIGHTER_STATUS_THROW_WORK_INT_TARGET_OBJECT), WorkModule::get_int64(boma,*FIGHTER_STATUS_THROW_WORK_INT_TARGET_HIT_GROUP), WorkModule::get_int64(boma,*FIGHTER_STATUS_THROW_WORK_INT_TARGET_HIT_NO));
        }
    }
}
...
unsafe fn lucina_nspecialendmax(fighter: &mut L2CAgentBase) {
    ...
    if WorkModule::get_int(boma, *FIGHTER_INSTANCE_WORK_ID_INT_KIND) == *FIGHTER_KIND_KIRBY {
        ...
        if macros::is_excute(fighter) {
            ...
            macros::ATTACK(fighter, 2, 0, Hash40::new("top"), 9.0 * DMG_RATIO[entry_id(boma)], 60, 80, 0, 30, 3.0, 0.0, 5.0, 8.0, Some(0.0), Some(5.0), Some(20.0), 1.0, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_paralyze"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_ELEC, *ATTACK_REGION_SWORD);
            macros::ATTACK(fighter, 3, 0, Hash40::new("top"), 9.0 * DMG_RATIO[entry_id(boma)], 60, 80, 0, 30, 3.0, 0.0, 5.0, 25.0, Some(0.0), Some(5.0), Some(27.0), 1.0, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_paralyze"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_ELEC, *ATTACK_REGION_SWORD);
            macros::ATTACK(fighter, 0, 0, Hash40::new("top"), 9.0 * DMG_RATIO[entry_id(boma)], 60, 80, 0, 30, 0.9, 0.0, 5.0, 17.0, Some(0.0), Some(5.0), Some(22.0), 1.8, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_paralyze"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_ELEC, *ATTACK_REGION_SWORD);
            macros::ATTACK(fighter, 1, 0, Hash40::new("top"), 9.0 * DMG_RATIO[entry_id(boma)], 60, 80, 0, 30, 0.9, 0.0, 5.0, 23.5, Some(0.0), Some(5.0), Some(28.9), 1.8, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_paralyze"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_ELEC, *ATTACK_REGION_SWORD);
        }
        sv_animcmd::frame(lua_state, 9.0);
        if macros::is_excute(fighter) {
            AttackModule::clear(boma, 0, false);
...
unsafe fn lucina_sspecial1(fighter: &mut L2CAgentBase) {
    ...
    if macros::is_excute(fighter) {
        AttackModule::clear_all(boma);
        macros::ATTACK(fighter, 1, 0, Hash40::new("top"), 0.8, 20, 30, 20, 40, 3.0, 0.0, 12.0, 9.0, Some(0.0), Some(4.0), Some(9.0), 0.4, 0.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_F, true, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_elec"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
        macros::ATTACK(fighter, 0, 0, Hash40::new("top"), 0.8, 10, 30, 20, 120, 3.0, 0.0, 12.0, -5.0, Some(0.0), Some(4.0), Some(-5.0), 0.4, 0.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_F, true, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_elec"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
...
unsafe fn lucina_sspecial1exp(fighter: &mut L2CAgentBase) {
    ...
    sv_animcmd::frame(lua_state, 42.0);
    if macros::is_excute(fighter) {
        ControlModule::set_rumble(boma, Hash40::new("rbkind_nohit11"), 0, false, 0);
    }
    sv_animcmd::frame(lua_state, 44.0);
    if macros::is_excute(fighter) {
...
unsafe fn lucina_sspecial1air(fighter: &mut L2CAgentBase) {
    ...
    sv_animcmd::frame(lua_state, 46.0);
    if macros::is_excute(fighter) {
        WorkModule::off_flag(boma, *FIGHTER_MARTH_STATUS_SPECIAL_S_FLAG_MOTION_CHANGE_ENABLE);
...
unsafe fn lucina_sspecial2lwair(fighter: &mut L2CAgentBase) {
    ...
    if macros::is_excute(fighter) {
        ...
        let vely : f32;
        if IS_EX[entry_id(boma)] == true {
            dmg = 12.0 * DMG_RATIO[entry_id(boma)];
            angle = 290;
            velx = 1.75;
            vely = -3.5;
        }
        else {
            dmg = 8.0 * DMG_RATIO[entry_id(boma)];
            angle = 40;
            velx = 1.5;
            vely = -3.0;
        }
...
unsafe fn lucina_sspecial2hiair(fighter: &mut L2CAgentBase) {
    ...
    if macros::is_excute(fighter) {
        ...
        let vely : f32;
        if IS_EX[entry_id(boma)] == true {
            dmg = 16.0 * DMG_RATIO[entry_id(boma)];
            kbg = 90;
            velx = 2.0;
            vely = -1.5;
        }
...
unsafe fn lucina_uspecial(fighter: &mut L2CAgentBase) {
    ...
    if IS_EX[entry_id(boma)] {
        ...
        if macros::is_excute(fighter) {
            macros::ATTACK(fighter, 2, 0, Hash40::new("top"), 10.0 * DMG_RATIO[entry_id(boma)], 79, 60, 0, 70, 4.0, 0.0, 8.0, 8.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
            macros::ATTACK(fighter, 3, 0, Hash40::new("top"), 10.0 * DMG_RATIO[entry_id(boma)], 79, 60, 0, 70, 4.0, 0.0, 8.0, 4.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
            WorkModule::on_flag(boma, *FIGHTER_MARTH_STATUS_SPECIAL_HI_FLAG_SPECIAL_HI_SET_LR);
            WorkModule::on_flag(boma, *FIGHTER_MARTH_STATUS_SPECIAL_HI_FLAG_TRANS_MOVE);
        }
        sv_animcmd::frame(lua_state, 6.0);
        if macros::is_excute(fighter) {
            upper_invuln(boma, false);
            macros::ATTACK(fighter, 0, 0, Hash40::new("sword1"), 7.0 * DMG_RATIO[entry_id(boma)], 79, 50, 0, 50, 5.0, 0.0, 0.0, 4.5, None, None, None, 0.9, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
            macros::ATTACK(fighter, 1, 0, Hash40::new("sword1"), 7.0 * DMG_RATIO[entry_id(boma)], 79, 50, 0, 50, 5.0, 0.0, 0.0, -1.5, None, None, None, 0.9, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_POS, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_cutup"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_CUTUP, *ATTACK_REGION_SWORD);
        }
        sv_animcmd::frame(lua_state, 7.0);
        macros::FT_MOTION_RATE(fighter, 1.0);
        if macros::is_excute(fighter) {
...
unsafe fn lucina_dspecial(fighter: &mut L2CAgentBase) {
    ...
    if macros::is_excute(fighter) {
        ...
        || dir == 8
        || dir == 2 {
            ROMAN_MOVE[entry_id(boma)] = 0.0;
        }
        else if dir == 4
        || dir == 7
        || dir == 1 {
            ROMAN_MOVE[entry_id(boma)] = -2.0;
        }
        else {
            ROMAN_MOVE[entry_id(boma)] = 2.0;
        }
    ...
    if macros::is_excute(fighter) {
        ...
        IS_ROMAN_MOVE[entry_id(boma)] = true;
    }
