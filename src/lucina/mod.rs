...
pub fn meter_control(fighter: &mut L2CFighterCommon) {
    unsafe {
...
pub fn special_lw_check(fighter: &mut L2CFighterCommon) {
    unsafe {
        ...
        if fighter_kind == *FIGHTER_KIND_LUCINA {
            ...
            && MotionModule::motion_kind(module_accessor) != smash::hash40("catch_attack") {
            ...
            else if StatusModule::status_kind(module_accessor) == *FIGHTER_STATUS_KIND_THROW{
                let throwframe : f32;
                if MotionModule::motion_kind(module_accessor) == smash::hash40("throw_f") {
                    _ONE_MORE_COUNTER[entry_id] = 4;
                    throwframe = 18.0;
                    println!("Throw F frame set!");
                }
                else if MotionModule::motion_kind(module_accessor) == smash::hash40("throw_b") {
                    _ONE_MORE_COUNTER[entry_id] = 4;
                    throwframe = 19.0;
                    println!("Throw B frame set!");
                }
                else if MotionModule::motion_kind(module_accessor) == smash::hash40("throw_hi") {
                    _ONE_MORE_COUNTER[entry_id] = 4;
                    throwframe = 13.0;
                    println!("Throw Hi frame set!");
                }
                else if MotionModule::motion_kind(module_accessor) == smash::hash40("throw_lw") {
                    _ONE_MORE_COUNTER[entry_id] = 4;
                    throwframe = 20.0;
                    println!("Throw Lw frame set!");
                }
                else{
                    throwframe = 20.0;
                }
                if MotionModule::frame(module_accessor) > throwframe && CAN_ONE_MORE[entry_id] == false {
                    CAN_ONE_MORE[entry_id] = true;
                }
                if _ONE_MORE_COUNTER[entry_id] > 0 && CAN_ONE_MORE[entry_id] == true {
                    if ControlModule::check_button_on(module_accessor, *CONTROL_PAD_BUTTON_GUARD)  && ControlModule::check_button_on(module_accessor, *CONTROL_PAD_BUTTON_CATCH) == false {
...
pub fn meter_effects(fighter: &mut L2CFighterCommon) {
    unsafe {
        let lua_state = fighter.lua_state_agent;
        let module_accessor = smash::app::sv_system::battle_object_module_accessor(lua_state);
        let fighter_kind = smash::app::utility::get_kind(module_accessor);
            ...
            if SP_GAUGE[entry_id] >= 25.0 && SHADOW_FRENZY[entry_id] == false {
                if _TIME_COUNTER[entry_id] < 12 {
                    ...
                    if SP_GAUGE[entry_id] >= 25.0 && SP_GAUGE[entry_id] < 50.0 {
                        ...
                        EffectModule::set_rgb(module_accessor, onemoreeff, 0.0, 5.0, 5.0);
                        EffectModule::set_rgb(module_accessor, onemoreeff2, 0.0, 5.0, 5.0);
                        _TIME_COUNTER[entry_id] = 0;
                    }
                    else if SP_GAUGE[entry_id] >= 50.0 && SP_GAUGE[entry_id] < 75.0 {
                        let onemoreeff: u32 = EffectModule::req_follow(module_accessor, smash::phx::Hash40::new("sys_hit_aura"), smash::phx::Hash40::new("haver"), &gfxcoords, &gfxcoords, 0.06, true, 0, 0, 0, 0, 0, true, true) as u32;
                    	let onemoreeff2: u32 = EffectModule::req_follow(module_accessor, smash::phx::Hash40::new("sys_hit_aura"), smash::phx::Hash40::new("havel"), &gfxcoords, &gfxcoords, 0.06, true, 0, 0, 0, 0, 0, true, true) as u32;
                        EffectModule::set_rgb(module_accessor, onemoreeff, 0.0, 0.0, 5.0);
                        EffectModule::set_rgb(module_accessor, onemoreeff2, 0.0, 0.0, 5.0);
                        _TIME_COUNTER[entry_id] = 0;
                    }
                    	...
                    	let onemoreeff2: u32 = EffectModule::req_follow(module_accessor, smash::phx::Hash40::new("sys_hit_aura"), smash::phx::Hash40::new("havel"), &gfxcoords, &gfxcoords, 0.06, true, 0, 0, 0, 0, 0, true, true) as u32;
                        EffectModule::set_rgb(module_accessor, onemoreeff, 5.0, 5.0, 0.0);
                        EffectModule::set_rgb(module_accessor, onemoreeff2, 5.0, 5.0, 0.0);
                        _TIME_COUNTER[entry_id] = 0;
                    }
                        ...
                        let onemoreeff: u32 = EffectModule::req_follow(module_accessor, smash::phx::Hash40::new("sys_hit_aura"), smash::phx::Hash40::new("haver"), &gfxcoords, &gfxcoords, 0.06, true, 0, 0, 0, 0, 0, true, true) as u32;
                    	let onemoreeff2: u32 = EffectModule::req_follow(module_accessor, smash::phx::Hash40::new("sys_hit_aura"), smash::phx::Hash40::new("havel"), &gfxcoords, &gfxcoords, 0.06, true, 0, 0, 0, 0, 0, true, true) as u32;
                        EffectModule::set_rgb(module_accessor, onemoreeff, 5.0, 5.0, 5.0);
                        EffectModule::set_rgb(module_accessor, onemoreeff2, 5.0, 5.0, 5.0);
                        _TIME_COUNTER[entry_id] = 0;
                    }
                }
		    }
...
pub fn shadow_frenzy_check(fighter: &mut L2CFighterCommon) {
    unsafe {
        let lua_state = fighter.lua_state_agent;
        let module_accessor = smash::app::sv_system::battle_object_module_accessor(lua_state);
        let fighter_kind = smash::app::utility::get_kind(module_accessor);
        ...
        if fighter_kind == *FIGHTER_KIND_LUCINA {
            if MotionModule::motion_kind(module_accessor) == smash::hash40("appeal_hi_l") || MotionModule::motion_kind(module_accessor) == smash::hash40("appeal_hi_r") {
                if SP_GAUGE[entry_id] == 100.0 && shadow_id(module_accessor) {
                    SHADOW_FRENZY[entry_id] = true;
                }
            }
...
pub fn lucina_utilt(fighter: &mut L2CFighterCommon) {
    acmd!({
        frame(Frame=5)
        if(is_excute){
            ATTACK(ID=0, Part=0, Bone=hash40("sword1"), Damage=9.0, Angle=71, KBG=60, FKB=0, BKB=65, Size=2.0, X=0.0, Y=-1.0, Z=1.0, X2=1.0, Y2=1.0, Z2=12.0, Hitlag=1.0, SDI=1.0, Clang_Rebound=ATTACK_SETOFF_KIND_OFF, FacingRestrict=ATTACK_LR_CHECK_F, SetWeight=false, ShieldDamage=0, Trip=0.0, Rehit=0, Reflectable=false, Absorbable=false, Flinchless=false, DisableHitlag=false, Direct_Hitbox=true, Ground_or_Air=COLLISION_SITUATION_MASK_GA, Hitbits=COLLISION_CATEGORY_MASK_ALL, CollisionPart=COLLISION_PART_MASK_ALL, FriendlyFire=false, Effect=hash40("collision_attr_cutup"), SFXLevel=ATTACK_SOUND_LEVEL_M, SFXType=COLLISION_SOUND_ATTR_CUTUP, Type=ATTACK_REGION_SWORD)
        }
        frame(Frame=7)
        if(is_excute){
            ATTACK(ID=0, Part=0, Bone=hash40("sword1"), Damage=9.0, Angle=71, KBG=60, FKB=0, BKB=65, Size=2.0, X=0.0, Y=-1.0, Z=1.0, X2=1.0, Y2=1.0, Z2=12.0, Hitlag=1.0, SDI=1.0, Clang_Rebound=ATTACK_SETOFF_KIND_OFF, FacingRestrict=ATTACK_LR_CHECK_F, SetWeight=false, ShieldDamage=0, Trip=0.0, Rehit=0, Reflectable=false, Absorbable=false, Flinchless=false, DisableHitlag=false, Direct_Hitbox=true, Ground_or_Air=COLLISION_SITUATION_MASK_GA, Hitbits=COLLISION_CATEGORY_MASK_ALL, CollisionPart=COLLISION_PART_MASK_ALL, FriendlyFire=false, Effect=hash40("collision_attr_cutup"), SFXLevel=ATTACK_SOUND_LEVEL_M, SFXType=COLLISION_SOUND_ATTR_CUTUP, Type=ATTACK_REGION_SWORD)
        ...
        frame(Frame=8)
        if(is_excute){
            ATTACK(ID=0, Part=0, Bone=hash40("sword1"), Damage=9.0, Angle=71, KBG=60, FKB=0, BKB=65, Size=2.0, X=0.0, Y=-1.0, Z=1.0, X2=1.0, Y2=0.0, Z2=12.0, Hitlag=1.0, SDI=1.0, Clang_Rebound=ATTACK_SETOFF_KIND_OFF, FacingRestrict=ATTACK_LR_CHECK_F, SetWeight=false, ShieldDamage=0, Trip=0.0, Rehit=0, Reflectable=false, Absorbable=false, Flinchless=false, DisableHitlag=false, Direct_Hitbox=true, Ground_or_Air=COLLISION_SITUATION_MASK_GA, Hitbits=COLLISION_CATEGORY_MASK_ALL, CollisionPart=COLLISION_PART_MASK_ALL, FriendlyFire=false, Effect=hash40("collision_attr_cutup"), SFXLevel=ATTACK_SOUND_LEVEL_M, SFXType=COLLISION_SOUND_ATTR_CUTUP, Type=ATTACK_REGION_SWORD)
        }
        frame(Frame=9)
        if(is_excute){
            ATTACK(ID=0, Part=0, Bone=hash40("sword1"), Damage=9.0, Angle=71, KBG=60, FKB=0, BKB=65, Size=2.0, X=0.0, Y=-1.0, Z=1.0, X2=1.0, Y2=-1.0, Z2=12.0, Hitlag=1.0, SDI=1.0, Clang_Rebound=ATTACK_SETOFF_KIND_OFF, FacingRestrict=ATTACK_LR_CHECK_F, SetWeight=false, ShieldDamage=0, Trip=0.0, Rehit=0, Reflectable=false, Absorbable=false, Flinchless=false, DisableHitlag=false, Direct_Hitbox=true, Ground_or_Air=COLLISION_SITUATION_MASK_GA, Hitbits=COLLISION_CATEGORY_MASK_ALL, CollisionPart=COLLISION_PART_MASK_ALL, FriendlyFire=false, Effect=hash40("collision_attr_cutup"), SFXLevel=ATTACK_SOUND_LEVEL_M, SFXType=COLLISION_SOUND_ATTR_CUTUP, Type=ATTACK_REGION_SWORD)
...
pub fn lucina_utilteffect(fighter: &mut L2CFighterCommon) {
    acmd!({
        frame(Frame=3)
        if(is_excute){
            AFTER_IMAGE4_ON_arg29(0x111623be1du64, 0x118f2aefa7u64, 12, 0x613f917e1u64, 0, 2.5, 0, 0x613f917e1u64, 0, 21.0, 0, true, LUA_VOID, 0x613f917e1u64, 0, 0, 0, 0, 0, 0, 1, 0, EFFECT_AXIS_X, 0, TRAIL_BLEND_ALPHA, 101, TRAIL_CULL_NONE, 1.29999995, 0.100000001)
...
pub fn lucina_nspecialendhi(fighter: &mut L2CFighterCommon) {
    acmd!({
        frame(Frame=1)
        FT_MOTION_RATE(FSM=0.125)
        frame(Frame=9)
...
pub fn lucina_nspecialendlw(fighter: &mut L2CFighterCommon) {
    acmd!({
        frame(Frame=1)
        FT_MOTION_RATE(FSM=0.125)
        frame(Frame=9)
...
pub fn lucina_nspecialendair(fighter: &mut L2CFighterCommon) {
    acmd!({
        frame(Frame=1)
        FT_MOTION_RATE(FSM=0.125)
        frame(Frame=9)
...
#[acmd_func(
    battle_object_category = BATTLE_OBJECT_CATEGORY_FIGHTER, 
    battle_object_kind = FIGHTER_KIND_LUCINA,
    animation = "special_air_n_end_hi",
    animcmd = "game_specialairnendhi")]
pub fn lucina_nspecialendhiair(fighter: &mut L2CFighterCommon) {
    acmd!({
        frame(Frame=1)
        FT_MOTION_RATE(FSM=0.125)
        frame(Frame=9)
...
#[acmd_func(
    battle_object_category = BATTLE_OBJECT_CATEGORY_FIGHTER, 
    battle_object_kind = FIGHTER_KIND_LUCINA,
    animation = "special_air_n_end_lw",
    animcmd = "game_specialairnendlw")]
pub fn lucina_nspecialendlwair(fighter: &mut L2CFighterCommon) {
    acmd!({
        frame(Frame=1)
        FT_MOTION_RATE(FSM=0.125)
        frame(Frame=9)
...
#[acmd_func(
    battle_object_category = BATTLE_OBJECT_CATEGORY_FIGHTER, 
    battle_object_kind = FIGHTER_KIND_LUCINA,
    animation = "special_n_end_max_hi",
    animcmd = "game_specialnendmaxhi")]
pub fn lucina_nspecialendmaxhi(fighter: &mut L2CFighterCommon) {
    acmd!({
        frame(Frame=1)
        FT_MOTION_RATE(FSM=0.125)
        frame(Frame=9)
...
#[acmd_func(
    battle_object_category = BATTLE_OBJECT_CATEGORY_FIGHTER, 
    battle_object_kind = FIGHTER_KIND_LUCINA,
    animation = "special_n_end_max_lw",
    animcmd = "game_specialnendmaxlw")]
pub fn lucina_nspecialendmaxlw(fighter: &mut L2CFighterCommon) {
    acmd!({
        frame(Frame=1)
        FT_MOTION_RATE(FSM=0.125)
        frame(Frame=9)
...
pub fn lucina_nspecialendmaxair(fighter: &mut L2CFighterCommon) {
    acmd!({
        frame(Frame=1)
        FT_MOTION_RATE(FSM=0.125)
        frame(Frame=9)
...
#[acmd_func(
    battle_object_category = BATTLE_OBJECT_CATEGORY_FIGHTER, 
    battle_object_kind = FIGHTER_KIND_LUCINA,
    animation = "special_air_n_end_max_hi",
    animcmd = "game_specialairnendmaxhi")]
pub fn lucina_nspecialendmaxhiair(fighter: &mut L2CFighterCommon) {
    acmd!({
        frame(Frame=1)
        FT_MOTION_RATE(FSM=0.125)
        frame(Frame=9)
...
#[acmd_func(
    battle_object_category = BATTLE_OBJECT_CATEGORY_FIGHTER, 
    battle_object_kind = FIGHTER_KIND_LUCINA,
    animation = "special_air_n_end_max_lw",
    animcmd = "game_specialairnendmaxlw")]
pub fn lucina_nspecialendmaxlwair(fighter: &mut L2CFighterCommon) {
    acmd!({
        frame(Frame=1)
        FT_MOTION_RATE(FSM=0.125)
        frame(Frame=9)
...
#[acmd_func(
    battle_object_category = BATTLE_OBJECT_CATEGORY_FIGHTER, 
    battle_object_kind = FIGHTER_KIND_LUCINA,
    animation = "special_s2_lw",
    animcmd = "game_specials2lw")]
pub fn lucina_sspecial2(fighter: &mut L2CFighterCommon) {
    acmd!({
        AttackModule::clear_all()
    });
}
...
#[acmd_func(
    battle_object_category = BATTLE_OBJECT_CATEGORY_FIGHTER, 
    battle_object_kind = FIGHTER_KIND_LUCINA,
    animation = "special_s2_hi",
    animcmd = "game_specials2hi")]
...
pub fn lucina_sspecial2hiair(fighter: &mut L2CFighterCommon) {
    acmd!({
        if(is_excute){
...
pub fn install() {
    acmd::add_hooks!(
        ...
        lucina_dair,
        lucina_nspecialend,
        lucina_nspecialendhi,
        lucina_nspecialendlw,
        lucina_nspecialendair,
        lucina_nspecialendhiair,
        lucina_nspecialendlwair,
        lucina_nspecialendmax,
        lucina_nspecialendmaxhi,
        lucina_nspecialendmaxlw,
        lucina_nspecialendmaxair,
        lucina_nspecialendmaxhiair,
        lucina_nspecialendmaxlwair,
        lucina_sspecial1,
        lucina_sspecial1air,
        lucina_sspecial2,
        lucina_sspecial2air,
