...
#[acmd_func(
    ...
    battle_object_kind = FIGHTER_KIND_PACKUN,
    animation = "attack_air_n",
    animcmd = "game_attackairn")]
pub fn packun_nair(fighter: &mut L2CFighterCommon) {
    acmd!({
        frame(Frame=2)
