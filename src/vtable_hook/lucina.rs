...
pub fn install() {
    MiscModule::patch_vtable_function(0x4fe6fc0, lucina_init as *const () as u64);
    MiscModule::patch_vtable_function(0x4fe7008, lucina_per_frame as *const () as u64);
    MiscModule::patch_vtable_function(0x4fe70c0, lucina_on_attack as *const () as u64);
}